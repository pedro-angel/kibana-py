"""Unit tests for AsyncFleetEpmClient."""
...
def _mock_response(mock_async_transport, body=None, status=200):
...
class TestAsyncFleetEpmClientInitialization:
    """Test AsyncFleetEpmClient initialization and wiring."""

    @pytest.mark.asyncio
    async def test_fleet_epm_client_initialization(self, mock_async_transport):
        """Test that AsyncFleetEpmClient can be initialized with a parent client."""
        client = AsyncKibana(_transport=mock_async_transport)
        fleet_epm_client = AsyncFleetEpmClient(client)
        assert fleet_epm_client._client is client

    @pytest.mark.asyncio
    async def test_fleet_epm_property_returns_client(self, mock_async_transport):
        """Test that client.fleet_epm returns an AsyncFleetEpmClient instance."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert isinstance(client.fleet_epm, AsyncFleetEpmClient)

    @pytest.mark.asyncio
    async def test_fleet_epm_property_caching(self, mock_async_transport):
...
class TestPackageDiscovery:
    ...
    @pytest.mark.asyncio
    async def test_get_categories(self, mock_async_transport):
        """Test GET /api/fleet/epm/categories without params."""
        _mock_response(mock_async_transport, {"items": [{"id": "custom", "count": 3}]})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.fleet_epm.get_categories()
    ...
    @pytest.mark.asyncio
    async def test_get_categories_with_params(self, mock_async_transport):
        """Test category query params are encoded as lowercase booleans."""
        _mock_response(mock_async_transport, {"items": []})
        client = AsyncKibana(_transport=mock_async_transport)
    ...
    @pytest.mark.asyncio
    async def test_get_packages_with_params(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages with all query params."""
        _mock_response(mock_async_transport, {"items": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_packages(
            category="custom",
            prerelease=False,
    ...
    @pytest.mark.asyncio
    async def test_get_installed_packages(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages/installed with params."""
        _mock_response(mock_async_transport, {"items": [], "total": 0})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_installed_packages(
    ...
    @pytest.mark.asyncio
    async def test_get_limited_packages(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages/limited."""
        _mock_response(mock_async_transport, {"items": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_limited_packages()
    ...
    @pytest.mark.asyncio
    async def test_get_package_latest(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages/{pkgName} (no version)."""
        _mock_response(
            mock_async_transport, {"item": {"name": "tcp", "version": "2.3.1"}}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.fleet_epm.get_package(pkg_name="tcp")
    ...
    @pytest.mark.asyncio
    async def test_get_package_with_version_and_params(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages/{pkgName}/{pkgVersion} with params."""
        _mock_response(mock_async_transport, {"item": {"name": "tcp"}})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_package(
            pkg_name="tcp",
            pkg_version="2.3.1",
    ...
    @pytest.mark.asyncio
    async def test_get_package_stats(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages/{pkgName}/stats."""
        _mock_response(mock_async_transport, {"response": {"package_policy_count": 0}})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.fleet_epm.get_package_stats(pkg_name="tcp")
    ...
    @pytest.mark.asyncio
    async def test_get_package_file_preserves_slashes(self, mock_async_transport):
        """Test GET package file path keeps slashes but quotes segments."""
        _mock_response(mock_async_transport, {})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_package_file(
    ...
    @pytest.mark.asyncio
    async def test_get_package_dependencies(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages/{pkgName}/{pkgVersion}/dependencies."""
        _mock_response(mock_async_transport, {"items": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_package_dependencies(
    ...
    @pytest.mark.asyncio
    async def test_get_verification_key_id(self, mock_async_transport):
        """Test GET /api/fleet/epm/verification_key_id."""
        _mock_response(mock_async_transport, {"id": "d27d666cd88e42b4"})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.fleet_epm.get_verification_key_id()
...
class TestInstallUpdateUninstall:
    ...
    @pytest.mark.asyncio
    async def test_install_package_latest_no_body(self, mock_async_transport):
        """Test POST install without version or body options."""
        _mock_response(mock_async_transport, {"items": [], "_meta": {"name": "tcp"}})
        client = AsyncKibana(_transport=mock_async_transport)
    ...
    @pytest.mark.asyncio
    async def test_install_package_with_version_body_and_params(
        ...
        await client.fleet_epm.install_package(
            pkg_name="tcp",
            pkg_version="2.3.0",
            force=True,
    ...
    @pytest.mark.asyncio
    async def test_install_package_by_upload(self, mock_async_transport):
        """Test POST /api/fleet/epm/packages raw archive upload."""
        _mock_response(
            mock_async_transport, {"items": [], "_meta": {"install_source": "upload"}}
        )
        client = AsyncKibana(_transport=mock_async_transport)
    ...
    @pytest.mark.asyncio
    async def test_install_package_by_upload_registers_raw_serializer(
        self, mock_async_transport
    ):
        ...
        _mock_response(mock_async_transport, {"items": []})
        mock_async_transport.serializers = SerializerCollection(DEFAULT_SERIALIZERS)
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.install_package_by_upload(content=b"PK\x03\x04fake")

        serializer = mock_async_transport.serializers.get_serializer("application/zip")
        assert serializer.dumps(b"PK\x03\x04fake") == b"PK\x03\x04fake"

    @pytest.mark.asyncio
    async def test_install_package_by_upload_gzip_content_type(
        self, mock_async_transport
    ):
        ...
        await client.fleet_epm.install_package_by_upload(
    ...
    @pytest.mark.asyncio
    async def test_update_package(self, mock_async_transport):
        """Test PUT /api/fleet/epm/packages/{pkgName} settings update."""
        _mock_response(mock_async_transport, {"item": {"keepPoliciesUpToDate": True}})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.update_package(
            pkg_name="tcp",
    ...
    @pytest.mark.asyncio
    async def test_update_package_with_version(self, mock_async_transport):
        """Test PUT /api/fleet/epm/packages/{pkgName}/{pkgVersion}."""
        _mock_response(mock_async_transport, {"item": {}})
        client = AsyncKibana(_transport=mock_async_transport)
    ...
    @pytest.mark.asyncio
    async def test_uninstall_package(self, mock_async_transport):
        """Test DELETE /api/fleet/epm/packages/{pkgName} with force."""
        _mock_response(mock_async_transport, {"items": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.uninstall_package(pkg_name="tcp", force=True)
    ...
    @pytest.mark.asyncio
    async def test_uninstall_package_with_version(self, mock_async_transport):
        """Test DELETE /api/fleet/epm/packages/{pkgName}/{pkgVersion}."""
        _mock_response(mock_async_transport, {"items": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.uninstall_package(pkg_name="tcp", pkg_version="2.3.1")

        kwargs = _call_kwargs(mock_async_transport)
        assert kwargs["target"] == "/api/fleet/epm/packages/tcp/2.3.1"

    @pytest.mark.asyncio
    async def test_rollback_package(self, mock_async_transport):
        """Test POST /api/fleet/epm/packages/{pkgName}/rollback."""
        _mock_response(mock_async_transport, {"version": "2.3.0", "success": True})
        client = AsyncKibana(_transport=mock_async_transport)
    ...
    @pytest.mark.asyncio
    async def test_review_upgrade(self, mock_async_transport):
    ...
    @pytest.mark.asyncio
    async def test_pkg_name_is_url_encoded(self, mock_async_transport):
        """Test that package names are URL-encoded in paths."""
        _mock_response(mock_async_transport, {"item": {}})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_package(pkg_name="weird pkg/name")
...
class TestBulkOperations:
    ...
    @pytest.mark.asyncio
    async def test_bulk_install_packages(self, mock_async_transport):
        """Test POST /api/fleet/epm/packages/_bulk passes packages through."""
        _mock_response(mock_async_transport, {"items": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.bulk_install_packages(
    ...
    @pytest.mark.asyncio
    async def test_bulk_upgrade_packages_normalizes_strings(self, mock_async_transport):
        """Test bulk upgrade converts name strings to {"name": ...} dicts."""
        _mock_response(mock_async_transport, {"taskId": "t-1"})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.fleet_epm.bulk_upgrade_packages(
            packages=["tcp", {"name": "udp", "version": "2.5.1"}],
            force=False,
            prerelease=False,
    ...
    @pytest.mark.asyncio
    async def test_get_bulk_upgrade_status(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages/_bulk_upgrade/{taskId}."""
        _mock_response(mock_async_transport, {"status": "success"})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.fleet_epm.get_bulk_upgrade_status(task_id="t-1")
    ...
    @pytest.mark.asyncio
    async def test_bulk_uninstall_packages(self, mock_async_transport):
        """Test POST /api/fleet/epm/packages/_bulk_uninstall body shape."""
        _mock_response(mock_async_transport, {"taskId": "t-2"})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.bulk_uninstall_packages(
    ...
    @pytest.mark.asyncio
    async def test_get_bulk_uninstall_status(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages/_bulk_uninstall/{taskId}."""
        _mock_response(mock_async_transport, {"status": "pending"})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_bulk_uninstall_status(task_id="t-2")
    ...
    @pytest.mark.asyncio
    async def test_bulk_rollback_packages_normalizes_strings(
        self, mock_async_transport
    ):
        """Test POST /api/fleet/epm/packages/_bulk_rollback body shape."""
        _mock_response(mock_async_transport, {"taskId": "t-3"})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.bulk_rollback_packages(packages=["tcp"])
    ...
    @pytest.mark.asyncio
    async def test_get_bulk_rollback_status(self, mock_async_transport):
        """Test GET /api/fleet/epm/packages/_bulk_rollback/{taskId}."""
        _mock_response(mock_async_transport, {"status": "success", "results": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_bulk_rollback_status(task_id="t-3")
...
class TestAssets:
    ...
    @pytest.mark.asyncio
    async def test_bulk_get_assets(self, mock_async_transport):
        """Test POST /api/fleet/epm/bulk_assets body shape."""
        _mock_response(mock_async_transport, {"items": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.bulk_get_assets(
    ...
    @pytest.mark.asyncio
    async def test_install_kibana_assets(self, mock_async_transport):
        """Test POST kibana_assets with force and space_ids body."""
        _mock_response(mock_async_transport, {"success": True})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.install_kibana_assets(
    ...
    @pytest.mark.asyncio
    async def test_install_kibana_assets_no_body(self, mock_async_transport):
    ...
    @pytest.mark.asyncio
    async def test_delete_kibana_assets(self, mock_async_transport):
        """Test DELETE kibana_assets."""
        _mock_response(mock_async_transport, {"success": True})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.delete_kibana_assets(pkg_name="tcp", pkg_version="2.3.1")
    ...
    @pytest.mark.asyncio
    async def test_install_rule_assets(self, mock_async_transport):
        """Test POST rule_assets with force body."""
        _mock_response(mock_async_transport, {"success": True})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.install_rule_assets(
    ...
    @pytest.mark.asyncio
    async def test_delete_datastream_assets(self, mock_async_transport):
    ...
    @pytest.mark.asyncio
    async def test_authorize_transforms_normalizes_strings(self, mock_async_transport):
        """Test POST transforms/authorize converts ID strings to dicts."""
        _mock_response(mock_async_transport, {})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.authorize_transforms(
            pkg_name="ti_util",
            pkg_version="1.1.0",
...
class TestCustomIntegrations:
    ...
    @pytest.mark.asyncio
    async def test_create_custom_integration(self, mock_async_transport):
        """Test POST /api/fleet/epm/custom_integrations body shape."""
        _mock_response(
            mock_async_transport, {"items": [], "_meta": {"install_source": "custom"}}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.fleet_epm.create_custom_integration(
    ...
    @pytest.mark.asyncio
    async def test_update_custom_integration(self, mock_async_transport):
        """Test PUT /api/fleet/epm/custom_integrations/{pkgName} body shape."""
        _mock_response(
            mock_async_transport, {"id": "my_app", "result": {"version": "1.0.1"}}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.fleet_epm.update_custom_integration(
            pkg_name="my_app",
            read_me_data="# My app",
            categories=["custom"],
        )
...
class TestDataStreamsAndTemplates:
    ...
    @pytest.mark.asyncio
    async def test_get_data_streams(self, mock_async_transport):
        """Test GET /api/fleet/data_streams."""
        _mock_response(mock_async_transport, {"data_streams": []})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.fleet_epm.get_data_streams()
    ...
    @pytest.mark.asyncio
    async def test_find_data_streams(self, mock_async_transport):
        """Test GET /api/fleet/epm/data_streams with all params."""
        _mock_response(mock_async_transport, {"items": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.find_data_streams(
            type="logs",
            dataset_query="tcp",
            sort_order="desc",
    ...
    @pytest.mark.asyncio
    async def test_get_inputs_template(self, mock_async_transport):
        """Test GET /api/fleet/epm/templates/{pkgName}/{pkgVersion}/inputs."""
        _mock_response(mock_async_transport, {"inputs": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.fleet_epm.get_inputs_template(
            pkg_name="tcp",
            pkg_version="2.3.1",
            format="json",
            prerelease=False,
...
class TestSpaceScoping:
    ...
    @pytest.mark.asyncio
    async def test_get_package_in_space(self, mock_async_transport):
    ...
    @pytest.mark.asyncio
    async def test_install_package_in_space(self, mock_async_transport):
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_get_package_not_found(self, mock_async_transport):
        ...
        with pytest.raises(NotFoundError):
            await client.fleet_epm.get_package(pkg_name="does-not-exist")

    @pytest.mark.asyncio
    async def test_install_package_bad_request(self, mock_async_transport):
        ...
        with pytest.raises(BadRequestError, match="out-of-date"):
            await client.fleet_epm.install_package(pkg_name="tcp", pkg_version="2.3.0")
