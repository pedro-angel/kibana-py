"""Unit tests for MaintenanceWindowsClient."""
...
class TestMaintenanceWindowsClientInitialization:
    """Test MaintenanceWindowsClient initialization."""

    def test_maintenance_windows_client_initialization(self, mock_transport):
        """Test that MaintenanceWindowsClient can be initialized with a parent client."""
        client = Kibana(_transport=mock_transport)
        maintenance_windows_client = MaintenanceWindowsClient(client)
        assert maintenance_windows_client._client is client

    def test_maintenance_windows_property_returns_client(self, mock_transport):
        """Test that client.maintenance_windows returns a MaintenanceWindowsClient."""
        client = Kibana(_transport=mock_transport)
        assert isinstance(client.maintenance_windows, MaintenanceWindowsClient)

    def test_maintenance_windows_property_caching(self, mock_transport):
...
class TestMaintenanceWindowsClientCreate:
    """Test MaintenanceWindowsClient.create() method."""
    ...
    def test_create_minimal(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        result = client.maintenance_windows.create(
            title="kbnpy-mw-example",
            schedule=SCHEDULE,
        )
    ...
    def test_create_with_all_parameters(self, mock_transport, mock_response):
...
class TestMaintenanceWindowsClientGet:
    """Test MaintenanceWindowsClient.get() method."""
    ...
    def test_get_success(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        result = client.maintenance_windows.get(id=MW_ID)
    ...
    def test_get_url_encodes_id(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        client.maintenance_windows.get(id="id with/special")

        call_kwargs = mock_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/maintenance_window/id%20with%2Fspecial"

    def test_get_in_space(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        client.maintenance_windows.get(
...
class TestMaintenanceWindowsClientFind:
    """Test MaintenanceWindowsClient.find() method."""

    def test_find_without_filters(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        result = client.maintenance_windows.find()
    ...
    def test_find_with_all_filters(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        client.maintenance_windows.find(
            title="kbnpy-mw-example",
            created_by="elastic",
    ...
    def test_find_with_single_status_string(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        client.maintenance_windows.find(status="archived")

        call_kwargs = mock_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/maintenance_window/_find?status=archived"

    def test_find_in_space(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        client.maintenance_windows.find(space_id="marketing", validate_spaces=False)

        call_kwargs = mock_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/s/marketing/api/maintenance_window/_find"


class TestMaintenanceWindowsClientUpdate:
    """Test MaintenanceWindowsClient.update() method."""
    ...
    def test_update_partial(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        result = client.maintenance_windows.update(id=MW_ID, enabled=False)
    ...
    def test_update_all_fields(self, mock_transport, mock_response):
    ...
    def test_update_url_encodes_id(self, mock_transport, mock_response):
        """Test that the maintenance window ID is URL-encoded in the path."""
        mock_transport.perform_request.return_value = mock_response(
            body=_maintenance_window_body()
        )
        ...
        client = Kibana(_transport=mock_transport)
        client.maintenance_windows.update(id="id with/special", title="x")

        call_kwargs = mock_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/maintenance_window/id%20with%2Fspecial"

    def test_update_in_space(self, mock_transport, mock_response):
...
class TestMaintenanceWindowsClientDelete:
    """Test MaintenanceWindowsClient.delete() method."""
    ...
    def test_delete_success(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        result = client.maintenance_windows.delete(id=MW_ID)
    ...
    def test_delete_in_space(self, mock_transport, mock_response):
        """Test deleting a maintenance window from a specific space."""
        mock_transport.perform_request.return_value = mock_response(body={}, status=204)

        client = Kibana(_transport=mock_transport)
        client.maintenance_windows.delete(
            id="abc123", space_id="marketing", validate_spaces=False
        )
...
class TestMaintenanceWindowsClientArchive:
    """Test MaintenanceWindowsClient.archive() and unarchive() methods."""

    def test_archive_success(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        result = client.maintenance_windows.archive(id=MW_ID)
    ...
    def test_archive_in_space(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        client.maintenance_windows.archive(
            id="abc123", space_id="marketing", validate_spaces=False
        )
    ...
    def test_unarchive_success(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        result = client.maintenance_windows.unarchive(id=MW_ID)
    ...
    def test_unarchive_in_space(self, mock_transport, mock_response):
        ...
        client = Kibana(_transport=mock_transport)
        client.maintenance_windows.unarchive(
            id="abc123", space_id="marketing", validate_spaces=False
        )
...
class TestMaintenanceWindowsClientErrorHandling:
    """Test MaintenanceWindowsClient error handling."""
    ...
    def test_get_not_found_error(self, mock_transport, mock_response):
        ...
        with pytest.raises(NotFoundError):
            client.maintenance_windows.get(id="nope")
