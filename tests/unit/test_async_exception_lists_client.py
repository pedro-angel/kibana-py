"""Unit tests for AsyncExceptionListsClient."""
...
class TestAsyncExceptionListsClientInitialization:
    """Test AsyncExceptionListsClient initialization and wiring."""

    async def test_initialization(self, mock_async_transport):
        """Test that AsyncExceptionListsClient can be initialized with a parent client."""
        client = AsyncKibana(_transport=mock_async_transport)
        exception_lists_client = AsyncExceptionListsClient(client)
        assert exception_lists_client._client is client

    async def test_property_returns_client(self, mock_async_transport):
        """Test that client.exception_lists returns an AsyncExceptionListsClient."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert isinstance(client.exception_lists, AsyncExceptionListsClient)
...
class TestAsyncExceptionListsCrud:
    ...
    async def test_create_minimal(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.create(
            name="Trusted hosts",
            description="Hosts that never alert",
            type="detection",
        )
    ...
    async def test_create_full_body(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.create(
            name="Trusted hosts",
            description="Hosts that never alert",
            type="detection",
            list_id="trusted-hosts",
    ...
    async def test_get_by_list_id(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.get(
    ...
    async def test_get_requires_id_or_list_id(self, mock_async_transport):
        """Test that get() raises ValueError without id/list_id."""
        client = AsyncKibana(_transport=mock_async_transport)
        with pytest.raises(ValueError, match="'id' or 'list_id'"):
            await client.exception_lists.get()
    ...
    async def test_update(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.update(
            name="Updated",
    ...
    async def test_delete_by_id(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.delete(
    ...
    async def test_delete_requires_id_or_list_id(self, mock_async_transport):
    ...
    async def test_get_not_found_error(self, mock_async_transport, mock_response):
        ...
        with pytest.raises(NotFoundError):
            await client.exception_lists.get(list_id="missing")


class TestAsyncExceptionListsFindDuplicateExportImport:
    ...
    async def test_find_no_params(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.find()
    ...
    async def test_find_param_encoding(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.find(
    ...
    async def test_duplicate(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.duplicate(
            list_id="trusted-hosts", namespace_type="single"
        )
    ...
    async def test_import_lists_builds_multipart_body(
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.import_lists(file=ndjson)
    ...
    async def test_import_lists_query_params(self, mock_async_transport, mock_response):
        """Test import_lists() encodes overwrite/as_new_list query params."""
        mock_async_transport.perform_request.return_value = mock_response(body={})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.import_lists(
    ...
    async def test_import_lists_encodes_list_to_ndjson(
        self, mock_async_transport, mock_response
    ):
    ...
    async def test_import_lists_validates_file(self, mock_async_transport):
        """Test import_lists() raises ValueError for an empty file."""
        client = AsyncKibana(_transport=mock_async_transport)
        with pytest.raises(ValueError, match="'file' is required"):
            await client.exception_lists.import_lists(file=b"")
        mock_async_transport.perform_request.assert_not_called()

    async def test_get_summary(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.get_summary(
            list_id="trusted-hosts",
            namespace_type="single",
    ...
    async def test_get_summary_requires_id_or_list_id(self, mock_async_transport):
        """Test that get_summary() raises ValueError without id/list_id."""
        client = AsyncKibana(_transport=mock_async_transport)
        with pytest.raises(ValueError, match="'id' or 'list_id'"):
            await client.exception_lists.get_summary()
...
class TestExceptionListItems:
    ...
    async def test_create_item(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.create_item(
            list_id="trusted-hosts",
            name="Trusted host",
            description="Ignore the build server",
            entries=_ENTRIES,
    ...
    async def test_get_item_by_item_id(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.get_item(
    ...
    async def test_get_item_requires_id_or_item_id(self, mock_async_transport):
    ...
    async def test_update_item(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.update_item(
            item_id="trusted-host-item",
            name="Updated item",
            description="Updated description",
            entries=_ENTRIES,
    ...
    async def test_delete_item(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.delete_item(item_id="trusted-host-item")
    ...
    async def test_delete_item_requires_id_or_item_id(self, mock_async_transport):
        """Test that delete_item() raises ValueError without id/item_id."""
        client = AsyncKibana(_transport=mock_async_transport)
        with pytest.raises(ValueError, match="'id' or 'item_id'"):
            await client.exception_lists.delete_item()

    async def test_find_items_multiple_lists(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.find_items(
    ...
    async def test_find_items_in_space(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.find_items(
...
class TestAsyncSharedAndRuleExceptions:
    """Test shared exception list and rule default exception methods."""

    async def test_create_shared_list(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.create_shared_list(
    ...
    async def test_create_rule_exceptions(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.create_rule_exceptions(
    ...
    async def test_create_rule_exceptions_quotes_rule_id(
        self, mock_async_transport, mock_response
    ):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.create_rule_exceptions(id="rule id/1", items=[])
...
class TestAsyncEndpointList:
    """Test Elastic Endpoint exception list methods."""

    async def test_create_endpoint_list(self, mock_async_transport, mock_response):
        """Test creating the endpoint exception list (idempotent)."""
        mock_async_transport.perform_request.return_value = mock_response(body={})

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.create_endpoint_list()
    ...
    async def test_create_endpoint_item(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.exception_lists.create_endpoint_item(
    ...
    async def test_get_endpoint_item(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.get_endpoint_item(item_id="trusted-process")
    ...
    async def test_get_endpoint_item_requires_id_or_item_id(self, mock_async_transport):
        """Test that get_endpoint_item() raises ValueError without id/item_id."""
        client = AsyncKibana(_transport=mock_async_transport)
        with pytest.raises(ValueError, match="'id' or 'item_id'"):
            await client.exception_lists.get_endpoint_item()

    async def test_update_endpoint_item(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.update_endpoint_item(
            id="53d8edfc-eebd-41da-986d-9905380537e9",
            name="Updated",
            description="Updated description",
            entries=_ENTRIES,
    ...
    async def test_delete_endpoint_item(self, mock_async_transport, mock_response):
    ...
    async def test_delete_endpoint_item_requires_id_or_item_id(
    ...
    async def test_find_endpoint_items(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.exception_lists.find_endpoint_items(
    ...
    async def test_find_endpoint_items_no_params(
        self, mock_async_transport, mock_response
    ):
