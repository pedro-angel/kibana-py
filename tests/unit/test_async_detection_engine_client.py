"""Unit tests for AsyncDetectionEngineClient."""
...
@pytest.fixture
def client_and_transport(mock_async_transport):
    """An AsyncKibana client wired to a mock transport returning 200 {}."""
    mock_async_transport.perform_request.return_value = ObjectApiResponse(
        body={},
        meta=Mock(status=200, headers={}),
    )
    return AsyncKibana(_transport=mock_async_transport), mock_async_transport
...
class TestAsyncDetectionEngineClientInitialization:
    """Test AsyncDetectionEngineClient initialization and wiring."""

    @pytest.mark.asyncio
    async def test_initialization(self, mock_async_transport):
        client = AsyncKibana(_transport=mock_async_transport)
        detection_engine_client = AsyncDetectionEngineClient(client)
        assert detection_engine_client._client is client

    @pytest.mark.asyncio
    async def test_property_returns_detection_engine_client(self, mock_async_transport):
        client = AsyncKibana(_transport=mock_async_transport)
        assert isinstance(client.detection_engine, AsyncDetectionEngineClient)
...
class TestPrivilegesAndIndex:
    ...
    @pytest.mark.asyncio
    async def test_get_privileges(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.get_privileges()
    ...
    @pytest.mark.asyncio
    async def test_create_alerts_index(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.create_alerts_index()
    ...
    @pytest.mark.asyncio
    async def test_get_alerts_index(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.get_alerts_index()
    ...
    @pytest.mark.asyncio
    async def test_delete_alerts_index(self, client_and_transport):
        client, transport = client_and_transport
    ...
    @pytest.mark.asyncio
    async def test_get_alerts_index_space_scoped(self, client_and_transport):
...
class TestRulesCrud:
    ...
    @pytest.mark.asyncio
    async def test_create_rule_body(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.create_rule(
            type="query",
            name="kbnpy rule",
            description="test",
            severity="low",
    ...
    @pytest.mark.asyncio
    async def test_create_rule_threat_match_fields(self, client_and_transport):
    ...
    @pytest.mark.asyncio
    async def test_get_rule_by_id(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.get_rule(id="07f4242f")
    ...
    @pytest.mark.asyncio
    async def test_get_rule_by_rule_id(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.get_rule(rule_id="kbnpy-rule")

        kwargs = _call_kwargs(transport)
        assert kwargs["target"] == "/api/detection_engine/rules?rule_id=kbnpy-rule"

    @pytest.mark.asyncio
    async def test_get_rule_requires_exactly_one_selector(self, client_and_transport):
        client, _ = client_and_transport
        with pytest.raises(ValueError):
            await client.detection_engine.get_rule()
        with pytest.raises(ValueError):
            await client.detection_engine.get_rule(id="a", rule_id="b")

    @pytest.mark.asyncio
    async def test_update_rule(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.update_rule(
            rule_id="kbnpy-rule",
            type="query",
            name="kbnpy rule v2",
            description="updated",
    ...
    @pytest.mark.asyncio
    async def test_update_rule_requires_selector(self, client_and_transport):
        client, _ = client_and_transport
        with pytest.raises(ValueError):
            await client.detection_engine.update_rule(
                type="query",
    ...
    @pytest.mark.asyncio
    async def test_patch_rule(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.patch_rule(
            id="07f4242f",
            tags=["kbnpy", "triage"],
        )
    ...
    @pytest.mark.asyncio
    async def test_patch_rule_requires_selector(self, client_and_transport):
        client, _ = client_and_transport
        with pytest.raises(ValueError):
            await client.detection_engine.patch_rule(tags=["x"])

    @pytest.mark.asyncio
    async def test_delete_rule_by_rule_id(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.delete_rule(rule_id="kbnpy-rule")
    ...
    @pytest.mark.asyncio
    async def test_delete_rule_requires_exactly_one_selector(
        self, client_and_transport
    ):
        client, _ = client_and_transport
        with pytest.raises(ValueError):
            await client.detection_engine.delete_rule()
        with pytest.raises(ValueError):
            await client.detection_engine.delete_rule(id="a", rule_id="b")

    @pytest.mark.asyncio
    async def test_find_rules_param_encoding(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.find_rules(
    ...
    @pytest.mark.asyncio
    async def test_find_rules_list_params_repeat(self, client_and_transport):
    ...
    @pytest.mark.asyncio
    async def test_find_rules_no_params(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.find_rules()
    ...
    @pytest.mark.asyncio
    async def test_find_rules_space_scoped(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.find_rules(
...
class TestRulesBulkExportImport:
    ...
    @pytest.mark.asyncio
    async def test_bulk_action_rules_edit(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.bulk_action_rules(
            action="edit",
            ids=["id-1", "id-2"],
    ...
    @pytest.mark.asyncio
    async def test_bulk_action_rules_dry_run_query_param(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.bulk_action_rules(
            action="delete",
    ...
    @pytest.mark.asyncio
    async def test_bulk_action_rules_run_window(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.bulk_action_rules(
            action="run",
            ids=["id-1"],
    ...
    @pytest.mark.asyncio
    async def test_export_rules(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.export_rules(
    ...
    @pytest.mark.asyncio
    async def test_export_rules_all_sends_no_body(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.export_rules()
    ...
    @pytest.mark.asyncio
    async def test_import_rules_multipart(self, client_and_transport):
        client, transport = client_and_transport
        rule = {"rule_id": "kbnpy-rule", "name": "kbnpy rule", "type": "query"}
        await client.detection_engine.import_rules(
            file=[rule],
            overwrite=True,
    ...
    @pytest.mark.asyncio
    async def test_import_rules_accepts_raw_bytes(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.import_rules(file=b'{"rule_id":"kbnpy-rule"}\n')

        body = _call_kwargs(transport)["body"]
        assert b'{"rule_id":"kbnpy-rule"}' in body

    @pytest.mark.asyncio
    async def test_import_rules_empty_file_raises(self, client_and_transport):
        client, _ = client_and_transport
        with pytest.raises(ValueError):
            await client.detection_engine.import_rules(file=b"")

    @pytest.mark.asyncio
    async def test_get_prepackaged_rules_status(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.get_prepackaged_rules_status()
    ...
    @pytest.mark.asyncio
    async def test_install_prepackaged_rules(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.install_prepackaged_rules()
    ...
    @pytest.mark.asyncio
    async def test_preview_rule(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.preview_rule(
            type="query",
            name="kbnpy preview",
            description="test",
            severity="low",
    ...
    @pytest.mark.asyncio
    async def test_get_tags(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.get_tags()
...
class TestSignals:
    ...
    @pytest.mark.asyncio
    async def test_search_alerts_body(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.search_alerts(
            query={"match_all": {}},
    ...
    @pytest.mark.asyncio
    async def test_set_alert_status_by_ids(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = ObjectApiResponse(
    ...
    @pytest.mark.asyncio
    async def test_set_alert_status_by_query(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.set_alert_status(
            status="open",
    ...
    @pytest.mark.asyncio
    async def test_set_alert_status_requires_exactly_one_selector(
        self, client_and_transport
    ):
        client, _ = client_and_transport
        with pytest.raises(ValueError):
            await client.detection_engine.set_alert_status(status="open")
        with pytest.raises(ValueError):
            await client.detection_engine.set_alert_status(
    ...
    @pytest.mark.asyncio
    async def test_set_alert_tags(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.set_alert_tags(
            ids=["alert-1"],
            tags_to_add=["triage"],
    ...
    @pytest.mark.asyncio
    async def test_set_alert_assignees(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.set_alert_assignees(
            ids=["alert-1"],
            add=["u_profile_1"],
            remove=[],
        )
...
class TestSignalsMigrations:
    ...
    @pytest.mark.asyncio
    async def test_create_alerts_migration(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.create_alerts_migration(
    ...
    @pytest.mark.asyncio
    async def test_get_alerts_migration_status(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.get_alerts_migration_status(from_="now-30d")
    ...
    @pytest.mark.asyncio
    async def test_finalize_alerts_migration(self, client_and_transport):
        client, transport = client_and_transport
    ...
    @pytest.mark.asyncio
    async def test_delete_alerts_migration(self, client_and_transport):
        client, transport = client_and_transport
        await client.detection_engine.delete_alerts_migration(migration_ids=["mig-1"])
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_get_rule_not_found_error(self, mock_async_transport):
        ...
        with pytest.raises(NotFoundError):
            await client.detection_engine.get_rule(rule_id="missing")

    @pytest.mark.asyncio
    async def test_create_rule_conflict_error(self, mock_async_transport):
    ...
    @pytest.mark.asyncio
    async def test_create_rule_returns_rule_body(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = ObjectApiResponse(
            body=_rule_body(),
            meta=Mock(status=200, headers={}),
        )
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.detection_engine.create_rule(
            type="query",
            name="kbnpy rule",
            description="test",
            severity="low",
