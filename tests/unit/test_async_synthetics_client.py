"""Unit tests for AsyncSyntheticsClient."""
...
def _mock_ok(mock_async_transport, body) -> None:
...
class TestAsyncSyntheticsClientInitialization:
    """Test AsyncSyntheticsClient initialization."""

    async def test_synthetics_client_initialization(self, mock_async_transport):
        """Test that AsyncSyntheticsClient can be initialized with a parent."""
        client = AsyncKibana(_transport=mock_async_transport)
        synthetics_client = AsyncSyntheticsClient(client)
        assert synthetics_client._client is client

    async def test_synthetics_property_returns_synthetics_client(
        self, mock_async_transport
    ):
        """Test that client.synthetics returns an AsyncSyntheticsClient."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert isinstance(client.synthetics, AsyncSyntheticsClient)

    async def test_synthetics_property_caching(self, mock_async_transport):
        """Test that the synthetics property returns the same instance."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert client.synthetics is client.synthetics


class TestAsyncSyntheticsClientMonitors:
    """Test monitor CRUD methods."""

    async def test_get_monitors_no_params(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.get_monitors()
    ...
    async def test_get_monitors_query_param_encoding(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.synthetics.get_monitors(
    ...
    async def test_get_monitors_space_scoped(self, mock_async_transport):
        """Test that space_id prefixes the path with /s/{space_id}."""
        _mock_ok(mock_async_transport, {"monitors": []})
    ...
    async def test_get_monitor(self, mock_async_transport):
        """Test getting a monitor by config ID."""
        _mock_ok(mock_async_transport, _monitor_body())

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.get_monitor(id=MONITOR_ID)
    ...
    async def test_get_monitor_id_url_encoded(self, mock_async_transport):
        """Test that the monitor ID is URL-encoded in the path."""
        _mock_ok(mock_async_transport, _monitor_body())

        client = AsyncKibana(_transport=mock_async_transport)
        await client.synthetics.get_monitor(id="my monitor/1")

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/synthetics/monitors/my%20monitor%2F1"

    async def test_create_monitor(self, mock_async_transport):
        """Test creating an HTTP monitor builds the documented body."""
        _mock_ok(mock_async_transport, _monitor_body())

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.create_monitor(
            type="http",
            name="kbnpy-synthetics-probe-mon",
            url="https://example.com",
    ...
    async def test_update_monitor_partial_body(self, mock_async_transport):
        """Test that a partial update only sends the provided fields."""
        _mock_ok(mock_async_transport, _monitor_body())

        client = AsyncKibana(_transport=mock_async_transport)
        await client.synthetics.update_monitor(id=MONITOR_ID, name="renamed")
    ...
    async def test_delete_monitor(self, mock_async_transport):
        """Test deleting a monitor returns the deletion result list."""
        _mock_ok(mock_async_transport, [{"id": MONITOR_ID, "deleted": True}])

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.delete_monitor(id=MONITOR_ID)
    ...
    async def test_bulk_delete_monitors(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.bulk_delete_monitors(ids=["id-1", "id-2"])
    ...
    async def test_test_monitor(self, mock_async_transport):
        """Test triggering an on-demand test run."""
        _mock_ok(mock_async_transport, {"testRunId": "run-1"})

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.test_monitor(monitor_id=MONITOR_ID)
...
class TestAsyncSyntheticsClientParams:
    """Test global parameter CRUD methods."""

    async def test_get_params(self, mock_async_transport):
        """Test listing parameters (body is a JSON array)."""
        _mock_ok(mock_async_transport, [_param_body()])

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.get_params()
    ...
    async def test_get_param(self, mock_async_transport):
        """Test getting a parameter by ID."""
        _mock_ok(mock_async_transport, _param_body())

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.get_param(id=PARAM_ID)
    ...
    async def test_create_param(self, mock_async_transport):
        """Test creating a single parameter."""
        _mock_ok(mock_async_transport, _param_body())

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.create_param(
            key="kbnpy-synthetics-key",
            value="s3cret",
            description="probe",
            tags=["kbnpy"],
    ...
    async def test_create_param_minimal_body(self, mock_async_transport):
        """Test that omitted optional args are excluded from the body."""
        _mock_ok(mock_async_transport, _param_body())

        client = AsyncKibana(_transport=mock_async_transport)
        await client.synthetics.create_param(key="k", value="v")

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["body"] == {"key": "k", "value": "v"}

    async def test_bulk_create_params(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.bulk_create_params(
            parameters=[
                {"key": "k1", "value": "v1"},
                {"key": "k2", "value": "v2"},
            ]
    ...
    async def test_update_param(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.update_param(
    ...
    async def test_delete_param(self, mock_async_transport):
        """Test deleting a parameter."""
        _mock_ok(mock_async_transport, [{"id": PARAM_ID, "deleted": True}])

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.delete_param(id=PARAM_ID)
    ...
    async def test_bulk_delete_params(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.bulk_delete_params(ids=["p1", "p2"])
...
class TestAsyncSyntheticsClientPrivateLocations:
    """Test private location CRUD methods."""

    async def test_get_private_locations(self, mock_async_transport):
        """Test listing private locations (body is a JSON array)."""
        _mock_ok(mock_async_transport, [_private_location_body()])

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.get_private_locations()
    ...
    async def test_get_private_location(self, mock_async_transport):
        """Test getting a private location by ID."""
        _mock_ok(mock_async_transport, _private_location_body())

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.get_private_location(id=LOCATION_ID)
    ...
    async def test_create_private_location(self, mock_async_transport):
        """Test creating a private location maps args to camelCase keys."""
        _mock_ok(mock_async_transport, _private_location_body())

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.create_private_location(
            label="kbnpy-synthetics-loc",
    ...
    async def test_update_private_location(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.update_private_location(
    ...
    async def test_delete_private_location(self, mock_async_transport):
        """Test deleting a private location."""
        _mock_ok(mock_async_transport, {})

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.synthetics.delete_private_location(id=LOCATION_ID)
    ...
    async def test_create_private_location_space_scoped(self, mock_async_transport):
        """Test that space_id prefixes the path for a write operation."""
        _mock_ok(mock_async_transport, _private_location_body())

        client = AsyncKibana(_transport=mock_async_transport)
        await client.synthetics.create_private_location(
            label="loc",
            agent_policy_id="policy-1",
            space_id="marketing",
...
class TestAsyncSyntheticsClientErrorHandling:
    """Test AsyncSyntheticsClient error handling."""

    async def test_get_monitor_not_found_error(self, mock_async_transport):
        ...
        with pytest.raises(NotFoundError):
            await client.synthetics.get_monitor(id="does-not-exist")

    async def test_create_monitor_bad_request_error(self, mock_async_transport):
        ...
        with pytest.raises(BadRequestError):
            await client.synthetics.create_monitor(
