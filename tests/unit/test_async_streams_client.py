"""Unit tests for AsyncStreamsClient."""
...
from kibana._async.client.streams import (
    AsyncStreamsClient,
...
class TestAsyncStreamsClientInitialization:
    """Test AsyncStreamsClient initialization and wiring."""

    async def test_initialization(self, mock_async_transport):
        client = AsyncKibana(_transport=mock_async_transport)
        streams_client = AsyncStreamsClient(client)
        assert streams_client._client is client

    async def test_streams_property_returns_streams_client(self, mock_async_transport):
        client = AsyncKibana(_transport=mock_async_transport)
        assert isinstance(client.streams, AsyncStreamsClient)

    async def test_streams_property_caching(self, mock_async_transport):
        client = AsyncKibana(_transport=mock_async_transport)
...
class TestStreamsGlobalOperations:
    ...
    async def test_enable(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"acknowledged": True, "result": "created"}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.enable()
    ...
    async def test_disable(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"acknowledged": True, "result": "deleted"}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.disable()
    ...
    async def test_resync(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(_ack())
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.resync()
    ...
    async def test_get_all(self, mock_async_transport):
        ...
        result = await client.streams.get_all()
    ...
    async def test_get_all_space_scoped(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"streams": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.streams.get_all(space_id="marketing", validate_spaces=False)
...
class TestStreamsCrud:
    ...
    async def test_get(self, mock_async_transport):
        ...
        result = await client.streams.get(name="logs.ecs")
    ...
    async def test_get_encodes_name(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"stream": {}})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.streams.get(name="logs.ecs/odd name")

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/streams/logs.ecs%2Fodd%20name"

    async def test_upsert_defaults_linked_object_lists(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"acknowledged": True, "result": "created"}
        )
        client = AsyncKibana(_transport=mock_async_transport)
        ...
        result = await client.streams.upsert(name="logs.ecs.myapp", stream=stream)
    ...
    async def test_upsert_with_linked_objects(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(_ack())
        client = AsyncKibana(_transport=mock_async_transport)
        queries = [
            {
    ...
    async def test_delete(self, mock_async_transport):
        ...
        result = await client.streams.delete(name="logs.ecs.myapp")
    ...
    async def test_fork(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"acknowledged": True, "result": "created"}
        )
        client = AsyncKibana(_transport=mock_async_transport)
        ...
        result = await client.streams.fork(
            name="logs.ecs",
    ...
    async def test_fork_omits_status_when_not_given(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(_ack())
        client = AsyncKibana(_transport=mock_async_transport)
...
class TestStreamsIngestAndQuerySettings:
    ...
    async def test_get_ingest(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"ingest": {"lifecycle": {"dsl": {}}}}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.get_ingest(name="logs.ecs")
    ...
    async def test_update_ingest(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(_ack())
        client = AsyncKibana(_transport=mock_async_transport)
        ingest = _wired_stream_definition()["ingest"]

        await client.streams.update_ingest(name="logs.ecs.myapp", ingest=ingest)
    ...
    async def test_get_query_settings(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"query": {"view": "$.myquerystream", "esql": ESQL}}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.get_query_settings(name="myquerystream")
    ...
    async def test_update_query_settings(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"acknowledged": True, "result": "created"}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.update_query_settings(
            name="myquerystream",
            esql=ESQL,
    ...
    async def test_update_query_settings_omits_field_descriptions(
        self, mock_async_transport
    ):
        mock_async_transport.perform_request.return_value = _ok(_ack())
        client = AsyncKibana(_transport=mock_async_transport)

        await client.streams.update_query_settings(name="myquerystream", esql=ESQL)
...
class TestStreamsQueries:
    ...
    async def test_get_queries(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"queries": [{"id": "q1", "title": "t", "esql": {"query": ESQL}}]}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.get_queries(name="logs.ecs.myapp")
    ...
    async def test_bulk_queries(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"acknowledged": True})
        client = AsyncKibana(_transport=mock_async_transport)
        operations = [
            {
                "index": {
        ...
        result = await client.streams.bulk_queries(
    ...
    async def test_upsert_query_full_body(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"acknowledged": True})
        client = AsyncKibana(_transport=mock_async_transport)
    ...
    async def test_upsert_query_minimal_body(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"acknowledged": True})
        client = AsyncKibana(_transport=mock_async_transport)
    ...
    async def test_delete_query(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"acknowledged": True})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.delete_query(
...
class TestStreamsSignificantEvents:
    ...
    async def test_get_significant_events_param_encoding(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"significant_events": [], "aggregated_occurrences": []}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.get_significant_events(
            name="logs.ecs.myapp",
            from_="now-24h",
            to="now",
            bucket_size="1h",
    ...
    async def test_get_significant_events_omits_optional_params(
        self, mock_async_transport
    ):
        mock_async_transport.perform_request.return_value = _ok(
            {"significant_events": [], "aggregated_occurrences": []}
        ...
        await client.streams.get_significant_events(
    ...
    async def test_generate_significant_events(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"queries": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.streams.generate_significant_events(
            name="logs.ecs.myapp",
            from_="now-24h",
            to="now",
    ...
    async def test_preview_significant_events(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"occurrences": [], "change_points": {"type": {}}}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.preview_significant_events(
            name="logs.ecs.myapp",
            from_="now-24h",
            to="now",
            bucket_size="1h",
...
class TestStreamsContentPacks:
    ...
    async def test_export_content(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = BinaryApiResponse(
            body=b"PK\x03\x04zipbytes",
            meta=Mock(status=200, headers={"content-type": "application/zip"}),
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.export_content(
            name="logs.ecs.myapp",
    ...
    async def test_export_content_custom_include(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({})
        client = AsyncKibana(_transport=mock_async_transport)
        include = {"objects": {"queries": [{"id": "q1"}]}}

        await client.streams.export_content(
            name="logs.ecs.myapp",
            content_name="myapp-pack",
            description="d",
            version="1.0.0",
    ...
    async def test_import_content_multipart_body(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok(
            {"acknowledged": True, "result": {"created": [], "updated": []}}
        )
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.import_content(
            name="logs.ecs.myapp",
    ...
    async def test_build_content_pack_multipart_helper(self):
        include = {"objects": {"all": {}}}
...
class TestStreamsAttachments:
    ...
    async def test_get_attachments_no_filters(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"attachments": []})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.get_attachments(name="logs.ecs.myapp")
    ...
    async def test_get_attachments_list_params_repeat_keys(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"attachments": []})
        client = AsyncKibana(_transport=mock_async_transport)

        await client.streams.get_attachments(
            name="logs.ecs.myapp",
            query="latency",
    ...
    async def test_bulk_attachments(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"acknowledged": True})
        client = AsyncKibana(_transport=mock_async_transport)
        operations = [
        ...
        result = await client.streams.bulk_attachments(
            name="logs.ecs.myapp", operations=operations
        )
    ...
    async def test_link_attachment(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"acknowledged": True})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.link_attachment(
            name="logs.ecs.myapp",
    ...
    async def test_unlink_attachment(self, mock_async_transport):
        mock_async_transport.perform_request.return_value = _ok({"acknowledged": True})
        client = AsyncKibana(_transport=mock_async_transport)

        result = await client.streams.unlink_attachment(
            name="logs.ecs.myapp",
            attachment_type="dashboard",
            attachment_id="dash-1",
        )
...
class TestZipSerializerRegistration:
    ...
    async def test_zip_serializer_roundtrip(self):
    ...
    async def test_zip_serializer_dumps_rejects_non_bytes(self):
        from elastic_transport import SerializationError

        with pytest.raises(SerializationError):
            _ZipContentSerializer().dumps({"not": "bytes"})

    async def test_ensure_zip_response_serializer_registers_once(self):
    ...
    async def test_ensure_zip_response_serializer_tolerates_missing_transport(self):
...
class TestStreamsErrorHandling:
    ...
    async def test_get_not_found_error(self, mock_async_transport):
        ...
        with pytest.raises(NotFoundError):
            await client.streams.get(name="logs.nope")

    async def test_upsert_bad_request_error(self, mock_async_transport):
