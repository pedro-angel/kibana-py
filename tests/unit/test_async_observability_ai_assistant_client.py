"""Unit tests for AsyncObservabilityAiAssistantClient."""
...
class TestAsyncObservabilityAiAssistantClientInitialization:
    """Test AsyncObservabilityAiAssistantClient initialization."""
    ...
    async def test_client_initialization(self, mock_async_transport):
        ...
        ai_client = AsyncObservabilityAiAssistantClient(client)
    ...
    async def test_property_returns_client(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        assert isinstance(
            client.observability_ai_assistant, AsyncObservabilityAiAssistantClient
        )
...
class TestAsyncObservabilityAiAssistantChatComplete:
    """Test AsyncObservabilityAiAssistantClient.chat_complete() method."""

    @pytest.mark.asyncio
    async def test_chat_complete_minimal(self, mock_async_transport):
        """Test chat completion with only the required parameters."""
        mock_async_transport.perform_request.return_value = _sse_response()

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.observability_ai_assistant.chat_complete(
            messages=_messages(),
    ...
    @pytest.mark.asyncio
    async def test_chat_complete_all_params(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.observability_ai_assistant.chat_complete(
            messages=_messages(),
            connector_id="my-connector",
            persist=True,
            actions=actions,
    ...
    @pytest.mark.asyncio
    async def test_chat_complete_omits_unset_optionals(self, mock_async_transport):
    ...
    @pytest.mark.asyncio
    async def test_chat_complete_space_scoped(self, mock_async_transport):
...
class TestAsyncObservabilityAiAssistantErrorHandling:
    """Test AsyncObservabilityAiAssistantClient error handling."""

    @pytest.mark.asyncio
    async def test_chat_complete_unknown_connector_not_found(
    ...
    @pytest.mark.asyncio
    async def test_chat_complete_validation_error(
        self, mock_async_transport, mock_response
    ):
