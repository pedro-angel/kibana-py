"""Unit tests for AsyncFleetAgentsClient."""
...
class TestAsyncFleetAgentsClientInitialization:
    """Test AsyncFleetAgentsClient initialization."""

    @pytest.mark.asyncio
    async def test_fleet_agents_client_initialization(self, mock_async_transport):
        """Test that AsyncFleetAgentsClient can be initialized with a parent client."""
        client = AsyncKibana(_transport=mock_async_transport)
        fleet_agents_client = AsyncFleetAgentsClient(client)
        assert fleet_agents_client._client is client

    @pytest.mark.asyncio
    async def test_fleet_agents_property_returns_client(self, mock_async_transport):
        """Test that client.fleet_agents returns a AsyncFleetAgentsClient instance."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert isinstance(client.fleet_agents, AsyncFleetAgentsClient)

    @pytest.mark.asyncio
    async def test_fleet_agents_property_caching(self, mock_async_transport):
        """Test that the fleet_agents property returns the same instance."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert client.fleet_agents is client.fleet_agents


class TestAsyncFleetAgentsStatus:
    """Test agent status summary and incoming data methods."""

    @pytest.mark.asyncio
    async def test_get_status(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get_status()
    ...
    @pytest.mark.asyncio
    async def test_get_status_with_filters(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.get_status(
    ...
    @pytest.mark.asyncio
    async def test_get_incoming_data(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get_incoming_data(
            agents_ids=["a1", "a2"],
            pkg_name="nginx",
            pkg_version="1.0.0",
            preview_data=True,
...
class TestAsyncFleetAgentsListAndCrud:
    """Test agent listing and per-agent CRUD methods."""

    @pytest.mark.asyncio
    async def test_get_all_defaults(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get_all()
    ...
    async def test_get_all_with_params(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.get_all(
            page=2,
            per_page=5,
    ...
    @pytest.mark.asyncio
    async def test_get_by_actions(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get_by_actions(action_ids=["act-1", "act-2"])
    ...
    async def test_get(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get(agent_id="agent-id-1", with_metrics=True)
    ...
    @pytest.mark.asyncio
    async def test_get_url_encodes_agent_id(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.get(agent_id="agent/1 x")

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/fleet/agents/agent%2F1%20x"

    @pytest.mark.asyncio
    async def test_update(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.update(
            agent_id="agent-id-1",
...
class TestAsyncFleetAgentsPerAgentOperations:
    """Test per-agent action methods."""

    @pytest.mark.asyncio
    async def test_create_action(self, mock_async_transport, mock_response):
        ...
        result = await client.fleet_agents.create_action(
            agent_id="agent-id-1", action=action
        )
    ...
    @pytest.mark.asyncio
    async def test_get_effective_config(self, mock_async_transport, mock_response):
        """Test get_effective_config."""
        mock_async_transport.perform_request.return_value = mock_response(body={})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.get_effective_config(agent_id="agent-id-1")
    ...
    @pytest.mark.asyncio
    async def test_migrate(self, mock_async_transport, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_change_privilege_level(self, mock_async_transport, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_reassign(self, mock_async_transport, mock_response):
        """Test reassign body construction."""
        mock_async_transport.perform_request.return_value = mock_response(body={})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.reassign(agent_id="agent-id-1", policy_id="policy-2")
    ...
    @pytest.mark.asyncio
    async def test_request_diagnostics(self, mock_async_transport, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_rollback(self, mock_async_transport, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_unenroll(self, mock_async_transport, mock_response):
        """Test unenroll body construction."""
        mock_async_transport.perform_request.return_value = mock_response(body={})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.unenroll(
            agent_id="agent-id-1", force=True, revoke=True
        )
    ...
    @pytest.mark.asyncio
    async def test_upgrade(self, mock_async_transport, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_get_uploads(self, mock_async_transport, mock_response):
        """Test get_uploads."""
        mock_async_transport.perform_request.return_value = mock_response(
            body={"items": []}
        )
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get_uploads(agent_id="agent-id-1")
...
class TestAsyncFleetAgentsActions:
    """Test agent action bookkeeping methods."""

    @pytest.mark.asyncio
    async def test_get_action_status(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get_action_status(
            page=0,
            per_page=10,
    ...
    @pytest.mark.asyncio
    async def test_cancel_action(self, mock_async_transport, mock_response):
        """Test cancel_action."""
        mock_async_transport.perform_request.return_value = mock_response(
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.cancel_action(action_id="act-1")
    ...
    @pytest.mark.asyncio
    async def test_get_available_versions(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get_available_versions()
...
class TestAsyncFleetAgentsBulkOperations:
    """Test bulk agent operation methods."""

    @pytest.mark.asyncio
    async def test_bulk_migrate(self, mock_async_transport, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_bulk_change_privilege_level(
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.bulk_change_privilege_level(
    ...
    @pytest.mark.asyncio
    async def test_bulk_reassign(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.bulk_reassign(
    ...
    @pytest.mark.asyncio
    async def test_bulk_request_diagnostics(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.bulk_request_diagnostics(
    ...
    @pytest.mark.asyncio
    async def test_bulk_rollback(self, mock_async_transport, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_bulk_unenroll(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.bulk_unenroll(
            agents=["a1", "a2"],
            force=True,
            revoke=True,
            batch_size=10,
    ...
    @pytest.mark.asyncio
    async def test_bulk_update_tags(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.bulk_update_tags(
            agents=["a1"],
    ...
    @pytest.mark.asyncio
    async def test_bulk_upgrade(self, mock_async_transport, mock_response):
...
class TestAsyncFleetAgentsFiles:
    """Test uploaded file methods."""

    @pytest.mark.asyncio
    async def test_get_file(self, mock_async_transport, mock_response):
        """Test get_file path construction with URL encoding."""
        mock_async_transport.perform_request.return_value = mock_response(body={})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.get_file(
            file_id="file-1", file_name="diagnostics file.zip"
        )
    ...
    @pytest.mark.asyncio
    async def test_delete_file(self, mock_async_transport, mock_response):
        """Test delete_file."""
        mock_async_transport.perform_request.return_value = mock_response(
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.delete_file(file_id="file-1")
...
class TestAsyncFleetAgentsSetupAndTags:
    """Test setup and tags methods."""

    @pytest.mark.asyncio
    async def test_get_setup_status(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get_setup_status()
    ...
    @pytest.mark.asyncio
    async def test_initiate_setup(self, mock_async_transport, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_get_tags(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_agents.get_tags(
            kuery="status:online", show_inactive=True
        )
...
class TestAsyncFleetAgentsSpaceScoping:
    """Test space-scoped path building."""

    @pytest.mark.asyncio
    async def test_get_all_with_space_id(self, mock_async_transport, mock_response):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_agents.get_all(space_id="marketing", validate_spaces=False)

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/s/marketing/api/fleet/agents"

    @pytest.mark.asyncio
    async def test_bulk_upgrade_with_space_id(
        self, mock_async_transport, mock_response
    ):
...
class TestAsyncFleetAgentsErrorHandling:
    """Test AsyncFleetAgentsClient error mapping."""
    ...
    async def test_get_not_found_error(self, mock_async_transport, mock_response):
        ...
        with pytest.raises(NotFoundError, match="Agent agent-id-1 not found"):
            await client.fleet_agents.get(agent_id="agent-id-1")

    @pytest.mark.asyncio
    async def test_bulk_upgrade_bad_request_error(
        self, mock_async_transport, mock_response
    ):
        ...
        with pytest.raises(BadRequestError):
            await client.fleet_agents.bulk_upgrade(agents=["a1"], version="9.4.3")
