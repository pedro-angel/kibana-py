"""Unit tests for AsyncFleetPoliciesClient."""
...
class TestAsyncFleetPoliciesClientInitialization:
    """Test AsyncFleetPoliciesClient initialization and wiring."""

    async def test_fleet_policies_client_initialization(self, mock_async_transport):
        """Test that AsyncFleetPoliciesClient can be initialized with a parent."""
        client = AsyncKibana(_transport=mock_async_transport)
        fleet_policies_client = AsyncFleetPoliciesClient(client)
        assert fleet_policies_client._client is client

    async def test_fleet_policies_property_returns_client(self, mock_async_transport):
        """Test that client.fleet_policies returns a AsyncFleetPoliciesClient."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert isinstance(client.fleet_policies, AsyncFleetPoliciesClient)

    async def test_fleet_policies_property_caching(self, mock_async_transport):
        """Test that the fleet_policies property returns the same instance."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert client.fleet_policies is client.fleet_policies


class TestAsyncAgentPoliciesList:
    """Test get_agent_policies()."""

    async def test_get_agent_policies_minimal(self, mock_async_transport):
        """Test listing agent policies with no parameters."""
        mock_async_transport.perform_request.return_value = _object_response(
            {"items": [_agent_policy_item()], "total": 1, "page": 1, "perPage": 20}
        )

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.get_agent_policies()
    ...
    async def test_get_agent_policies_param_encoding(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_policies.get_agent_policies(
            page=2,
            per_page=5,
            sort_field="name",
            sort_order="asc",
    ...
    async def test_get_agent_policies_in_space(self, mock_async_transport):
...
class TestAsyncAgentPolicyCreate:
    """Test create_agent_policy()."""

    async def test_create_agent_policy_minimal(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.create_agent_policy(
    ...
    async def test_create_agent_policy_full_body(self, mock_async_transport):
...
class TestAsyncAgentPolicyBulkGet:
    """Test bulk_get_agent_policies()."""

    async def test_bulk_get_agent_policies(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.bulk_get_agent_policies(
            ids=["id-1", "id-2"],
            full=True,
            ignore_missing=True,
            format="legacy",
...
class TestAsyncAgentPolicyGet:
    """Test get_agent_policy()."""

    async def test_get_agent_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.get_agent_policy(
    ...
    async def test_get_agent_policy_url_encodes_id(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_policies.get_agent_policy(agent_policy_id="policy id/1")

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/fleet/agent_policies/policy%20id%2F1"

    async def test_get_agent_policy_not_found(self, mock_async_transport):
        ...
        with pytest.raises(NotFoundError):
            await client.fleet_policies.get_agent_policy(agent_policy_id="missing")


class TestAsyncAgentPolicyUpdate:
    """Test update_agent_policy()."""

    async def test_update_agent_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.update_agent_policy(
...
class TestAsyncAgentPolicyAutoUpgradeStatus:
    """Test get_auto_upgrade_agents_status()."""

    async def test_get_auto_upgrade_agents_status(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.get_auto_upgrade_agents_status(
            agent_policy_id="policy-1"
        )
...
class TestAsyncAgentPolicyCopy:
    """Test copy_agent_policy()."""

    async def test_copy_agent_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.copy_agent_policy(
            agent_policy_id="policy-1",
            name="copied",
            description="a copy",
            format="legacy",
...
class TestAsyncAgentPolicyDownload:
    """Test download_agent_policy()."""

    async def test_download_agent_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.download_agent_policy(
            agent_policy_id="policy-1",
            download=True,
            standalone=True,
            kubernetes=False,
...
class TestAsyncAgentPolicyFull:
    """Test get_full_agent_policy()."""

    async def test_get_full_agent_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.get_full_agent_policy(
...
class TestAsyncAgentPolicyOutputs:
    """Test get_agent_policy_outputs() and get_agent_policies_outputs()."""

    async def test_get_agent_policy_outputs(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.get_agent_policy_outputs(
            agent_policy_id="policy-1"
        )
    ...
    async def test_get_agent_policies_outputs(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.get_agent_policies_outputs(
            ids=["policy-1"]
        )
...
class TestAsyncAgentPolicyDelete:
    """Test delete_agent_policy()."""

    async def test_delete_agent_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.delete_agent_policy(
...
class TestAsyncAgentlessPolicies:
    """Test create_agentless_policy() and delete_agentless_policy()."""

    async def test_create_agentless_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.create_agentless_policy(
    ...
    async def test_create_agentless_policy_bad_request(self, mock_async_transport):
        ...
        with pytest.raises(BadRequestError, match="agentless feature"):
            await client.fleet_policies.create_agentless_policy(
                name="kbnpy-fleet_policies-agentless",
                package={"name": "cspm", "version": "1.0.0"},
            )

    async def test_delete_agentless_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.delete_agentless_policy(
...
class TestAsyncPackagePoliciesList:
    """Test get_package_policies()."""

    async def test_get_package_policies_minimal(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.get_package_policies()
    ...
    async def test_get_package_policies_param_encoding(self, mock_async_transport):
        """Test that all query parameters are encoded with spec names."""
        mock_async_transport.perform_request.return_value = _object_response(
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_policies.get_package_policies(
            page=1,
            per_page=10,
            sort_field="name",
            sort_order="desc",
...
class TestAsyncPackagePolicyCreate:
    """Test create_package_policy()."""

    async def test_create_package_policy_simplified(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.create_package_policy(
            name="kbnpy-fleet_policies-pkg",
    ...
    async def test_create_package_policy_classic_body_mapping(
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_policies.create_package_policy(
            name="kbnpy-fleet_policies-pkg",
            package={"name": "log", "version": "2.4.4"},
            policy_ids=["policy-1"],
...
class TestAsyncPackagePolicyBulkGet:
    """Test bulk_get_package_policies()."""

    async def test_bulk_get_package_policies(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.bulk_get_package_policies(
...
class TestAsyncPackagePolicyGet:
    """Test get_package_policy()."""

    async def test_get_package_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.get_package_policy(
    ...
    async def test_get_package_policy_url_encodes_id(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        await client.fleet_policies.get_package_policy(package_policy_id="pkg id/1")

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/fleet/package_policies/pkg%20id%2F1"


class TestAsyncPackagePolicyUpdate:
    """Test update_package_policy()."""

    async def test_update_package_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.update_package_policy(
...
class TestAsyncPackagePolicyDelete:
    """Test delete_package_policy() and bulk_delete_package_policies()."""

    async def test_delete_package_policy(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.delete_package_policy(
    ...
    async def test_bulk_delete_package_policies(self, mock_async_transport):
        """Test bulk deleting package policies (list response body)."""
        mock_async_transport.perform_request.return_value = _list_response(
            [{"id": "pkg-1", "name": "kbnpy-fleet_policies-pkg", "success": True}]
        )

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.bulk_delete_package_policies(
...
class TestAsyncPackagePolicyUpgrade:
    """Test upgrade_package_policies() and upgrade_package_policies_dry_run()."""

    async def test_upgrade_package_policies(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.upgrade_package_policies(
    ...
    async def test_upgrade_package_policies_dry_run(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.fleet_policies.upgrade_package_policies_dry_run(
