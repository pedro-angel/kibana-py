"""Unit tests for AsyncWorkflowsClient."""
...
def _mock_object_response(mock_async_transport, body=None, status=200):
    """Wire an ObjectApiResponse into the mock async transport and return it."""
...
class TestAsyncWorkflowsClientInitialization:
    """Test AsyncWorkflowsClient initialization and wiring."""

    async def test_workflows_client_initialization(self, mock_async_transport):
        """Test that AsyncWorkflowsClient can be initialized with a parent client."""
        client = AsyncKibana(_transport=mock_async_transport)
        workflows_client = AsyncWorkflowsClient(client)
        assert workflows_client._client is client

    async def test_workflows_property_returns_client(self, mock_async_transport):
        """Test that client.workflows returns an AsyncWorkflowsClient instance."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert isinstance(client.workflows, AsyncWorkflowsClient)

    async def test_workflows_property_caching(self, mock_async_transport):
        """Test that the workflows property returns the same instance."""
        client = AsyncKibana(_transport=mock_async_transport)
        assert client.workflows is client.workflows


class TestAsyncWorkflowsClientCrud:
    """Test workflow CRUD methods."""

    async def test_create(self, mock_async_transport):
        """Test creating a workflow with a custom ID."""
        _mock_object_response(mock_async_transport, _workflow_body())

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.create(
            yaml=WORKFLOW_YAML, id="kbnpy-test-workflow"
        )
    ...
    async def test_create_without_id(self, mock_async_transport):
        """Test that the optional id is omitted from the body when not given."""
        _mock_object_response(mock_async_transport, _workflow_body())

        client = AsyncKibana(_transport=mock_async_transport)
        await client.workflows.create(yaml=WORKFLOW_YAML)

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["body"] == {"yaml": WORKFLOW_YAML}

    async def test_create_in_space(self, mock_async_transport):
    ...
    async def test_get(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get(id="kbnpy-test-workflow")
    ...
    async def test_get_url_encodes_id(self, mock_async_transport):
        """Test that the workflow ID is URL-encoded in the path."""
        _mock_object_response(mock_async_transport, _workflow_body())

        client = AsyncKibana(_transport=mock_async_transport)
        await client.workflows.get(id="my workflow/1")

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/workflows/workflow/my%20workflow%2F1"

    async def test_update(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.update(
            id="kbnpy-test-workflow",
            name="renamed",
    ...
    async def test_update_with_yaml(self, mock_async_transport):
        """Test replacing a workflow definition via yaml."""
        _mock_object_response(mock_async_transport, {"id": "kbnpy-test-workflow"})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.workflows.update(id="kbnpy-test-workflow", yaml=WORKFLOW_YAML)

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["body"] == {"yaml": WORKFLOW_YAML}

    async def test_delete(self, mock_async_transport):
        """Test deleting a workflow with the force flag."""
        _mock_object_response(mock_async_transport, {})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.workflows.delete(id="kbnpy-test-workflow", force=True)
    ...
    async def test_clone(self, mock_async_transport):
        """Test cloning a workflow."""
        _mock_object_response(
            mock_async_transport, _workflow_body(id="kbnpy-test-workflow-copy")
        )

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.clone(id="kbnpy-test-workflow")
...
class TestAsyncWorkflowsClientSearchAndBulk:
    """Test search, bulk and lookup methods."""

    async def test_get_all(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_all(
            query="kbnpy",
            size=5,
            page=1,
            enabled=[True, False],
    ...
    async def test_get_all_no_params(self, mock_async_transport):
        """Test that no query string is added when no filters are given."""
        _mock_object_response(
            mock_async_transport, {"results": [], "total": 0, "page": 1, "size": 20}
        )

        client = AsyncKibana(_transport=mock_async_transport)
        await client.workflows.get_all()

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["target"] == "/api/workflows"

    async def test_bulk_create(self, mock_async_transport):
        """Test bulk creating workflows with overwrite."""
        _mock_object_response(mock_async_transport, {"created": [_workflow_body()]})

        client = AsyncKibana(_transport=mock_async_transport)
        workflows = [{"id": "kbnpy-test-workflow", "yaml": WORKFLOW_YAML}]
        result = await client.workflows.bulk_create(workflows=workflows, overwrite=True)
    ...
    async def test_bulk_delete(self, mock_async_transport):
        """Test bulk deleting workflows by IDs."""
        _mock_object_response(
            mock_async_transport, {"total": 2, "deleted": 2, "failures": []}
        )

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.bulk_delete(ids=["wf-1", "wf-2"], force=True)
    ...
    async def test_mget(self, mock_async_transport):
        """Test multi-getting workflows by IDs (body is a JSON array)."""
        mock_async_transport.perform_request.return_value = ListApiResponse(
            body=[{"id": "wf-1", "name": "wf-1"}],
            meta=Mock(status=200, headers={}),
        )

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.mget(ids=["wf-1"], source=["id", "name"])
    ...
    async def test_export(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.export(ids=["wf-1"])
...
class TestAsyncWorkflowsClientMetadata:
    """Test aggs, connectors, schema and stats methods."""

    async def test_get_aggs(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_aggs(fields=["tags", "createdBy"])
        ...
        assert call_kwargs["method"] == "GET"
        assert call_kwargs["target"] == (
            "/api/workflows/aggs?fields=tags&fields=createdBy"
        )

    async def test_get_connectors(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_connectors()
    ...
    async def test_get_schema(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_schema(loose=False)
    ...
    async def test_get_stats(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_stats()
...
class TestAsyncWorkflowsClientRunAndTest:
    """Test run, test and test_step methods."""

    async def test_run(self, mock_async_transport):
        """Test running a workflow with inputs and metadata."""
        _mock_object_response(mock_async_transport, {"workflowExecutionId": "exec-1"})
    ...
    async def test_test_with_workflow_id(self, mock_async_transport):
        """Test starting a test run of an existing workflow."""
        _mock_object_response(mock_async_transport, {"workflowExecutionId": "exec-2"})

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.test(
            workflow_id="kbnpy-test-workflow", inputs={}
        )
    ...
    async def test_test_with_yaml(self, mock_async_transport):
        """Test starting a test run of an ad-hoc YAML definition."""
        _mock_object_response(mock_async_transport, {"workflowExecutionId": "exec-3"})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.workflows.test(workflow_yaml=WORKFLOW_YAML, inputs={"a": 1})
    ...
    async def test_test_step(self, mock_async_transport):
        """Test starting a single-step test run."""
        _mock_object_response(mock_async_transport, {"workflowExecutionId": "exec-4"})

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.test_step(
            step_id="log_step",
...
class TestAsyncWorkflowsClientExecutions:
    """Test execution-related methods."""

    async def test_get_executions(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_executions(
            workflow_id="kbnpy-test-workflow",
    ...
    async def test_get_step_executions(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_step_executions(
            workflow_id="kbnpy-test-workflow",
            step_id="log_step",
            include_input=True,
    ...
    async def test_cancel_all_executions(self, mock_async_transport):
        """Test cancelling all active executions of a workflow."""
        _mock_object_response(mock_async_transport, {})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.workflows.cancel_all_executions(workflow_id="kbnpy-test-workflow")
    ...
    async def test_get_execution(self, mock_async_transport):
        """Test getting a single execution with input/output flags."""
        _mock_object_response(mock_async_transport, _execution_body())

        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_execution(
    ...
    async def test_cancel_execution(self, mock_async_transport):
        """Test cancelling a single execution."""
        _mock_object_response(mock_async_transport, {})

        client = AsyncKibana(_transport=mock_async_transport)
        await client.workflows.cancel_execution(execution_id="exec-1")

        call_kwargs = mock_async_transport.perform_request.call_args[1]
        assert call_kwargs["method"] == "POST"
        assert call_kwargs["target"] == "/api/workflows/executions/exec-1/cancel"

    async def test_resume_execution(self, mock_async_transport):
    ...
    async def test_get_execution_children(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_execution_children(execution_id="exec-1")
    ...
    async def test_get_execution_logs(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_execution_logs(
            execution_id="exec-1",
    ...
    async def test_get_step_execution(self, mock_async_transport):
        ...
        client = AsyncKibana(_transport=mock_async_transport)
        result = await client.workflows.get_step_execution(
...
class TestAsyncWorkflowsClientErrorHandling:
    """Test error mapping for the async workflows namespace."""

    async def test_get_not_found_error(self, mock_async_transport):
        ...
        with pytest.raises(NotFoundError):
            await client.workflows.get(id="missing-workflow")

    async def test_create_bad_request_error(self, mock_async_transport):
        ...
        with pytest.raises(BadRequestError):
            await client.workflows.create(yaml="not: [valid")

    async def test_resume_conflict_error(self, mock_async_transport):
        ...
        with pytest.raises(ConflictError):
            await client.workflows.resume_execution(execution_id="exec-1", input={})
