...
class WorkflowsClient(NamespaceClient):
    ...
    def create(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/workflows/workflow", space_id, validate_spaces
        )
    ...
    def get(
        ...
        *,
        ...
        Example:
            >>> workflow = client.workflows.get(id="my-workflow")
            >>> print(workflow.body["name"])
        """
        path = self._build_space_path(
            f"/api/workflows/workflow/{_quote(id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def clone(
        ...
        *,
        ...
        Example:
            >>> cloned = client.workflows.clone(id="my-workflow")
            >>> print(cloned.body["id"])
            my-workflow-copy
        """
        path = self._build_space_path(
            f"/api/workflows/workflow/{_quote(id)}/clone", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def run(
        ...
        *,
        ...
        Example:
            >>> run = client.workflows.run(id="my-workflow", inputs={})
        ...
        path = self._build_space_path(
            f"/api/workflows/workflow/{_quote(id)}/run", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_all(
        ...
        *,
        ...
        if tags is not None:
            params["tags"] = tags
        path = self._build_space_path("/api/workflows", space_id, validate_spaces)
        return self.perform_request(
            "GET",
            path,
            params=params,
    ...
    def bulk_create(
        ...
        *,
        ...
        Example:
            >>> result = client.workflows.bulk_create(
    ...
    def bulk_delete(
        ...
        *,
        ...
        Example:
            >>> result = client.workflows.bulk_delete(ids=["wf-1", "wf-2"])
    ...
    def mget(
        ...
        *,
        ...
        Example:
            >>> found = client.workflows.mget(ids=["wf-1", "wf-2"])
            >>> print([wf["id"] for wf in found.body])
        """
        body: dict[str, Any] = {"ids": ids}
        if source is not None:
            body["source"] = source
        path = self._build_space_path("/api/workflows/mget", space_id, validate_spaces)
        return self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    def export(
        ...
        *,
        ...
        Example:
            >>> exported = client.workflows.export(ids=["wf-1"])
            >>> print(exported.body["entries"][0]["yaml"])
        """
        path = self._build_space_path(
            "/api/workflows/export", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_aggs(
        ...
        *,
        ...
        Example:
            >>> aggs = client.workflows.get_aggs(fields=["createdBy"])
            >>> print(aggs.body["createdBy"])
        """
        path = self._build_space_path("/api/workflows/aggs", space_id, validate_spaces)
        return self.perform_request(
            "GET",
            path,
    ...
    def get_connectors(
        ...
        *,
        ...
        Example:
            >>> connectors = client.workflows.get_connectors()
            >>> print(sorted(connectors.body["connectorTypes"]))
        """
        path = self._build_space_path(
            "/api/workflows/connectors", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_schema(
        ...
        *,
        ...
        Example:
            >>> schema = client.workflows.get_schema(loose=False)
            >>> print(schema.body["$schema"])
            http://json-schema.org/draft-07/schema#
        """
        path = self._build_space_path(
            "/api/workflows/schema", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_stats(
        ...
        *,
        ...
        Example:
            >>> stats = client.workflows.get_stats()
            >>> print(stats.body["workflows"])
            {'enabled': 1, 'disabled': 0}
        """
        path = self._build_space_path("/api/workflows/stats", space_id, validate_spaces)
        return self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    def test(
        ...
        *,
        ...
        path = self._build_space_path("/api/workflows/test", space_id, validate_spaces)
        return self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    def test_step(
        ...
        *,
        ...
        Example:
            >>> test_run = client.workflows.test_step(
            ...     step_id="log_step",
            ...     context_override={},
        ...
        path = self._build_space_path(
            "/api/workflows/step/test", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_executions(
        ...
        *,
        ...
        Example:
            >>> executions = client.workflows.get_executions(
        ...
        if size is not None:
            params["size"] = size
        path = self._build_space_path(
            f"/api/workflows/workflow/{_quote(workflow_id)}/executions",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_step_executions(
        ...
        *,
        ...
        Example:
            >>> steps = client.workflows.get_step_executions(
        ...
        if size is not None:
            params["size"] = size
        path = self._build_space_path(
            f"/api/workflows/workflow/{_quote(workflow_id)}/executions/steps",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def cancel_all_executions(
        ...
        *,
        ...
        Example:
            >>> client.workflows.cancel_all_executions(
            ...     workflow_id="my-workflow"
            ... )
        """
        path = self._build_space_path(
            f"/api/workflows/workflow/{_quote(workflow_id)}/executions/cancel",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def cancel_execution(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/workflows/executions/{_quote(execution_id)}/cancel",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def resume_execution(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/workflows/executions/{_quote(execution_id)}/resume",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_execution_children(
        ...
        *,
        ...
        Example:
            >>> children = client.workflows.get_execution_children(
            ...     execution_id="be42ad95-..."
            ... )
            >>> print(len(children.body))
        """
        path = self._build_space_path(
            f"/api/workflows/executions/{_quote(execution_id)}/children",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_execution_logs(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/workflows/executions/{_quote(execution_id)}/logs",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_step_execution(
        ...
        *,
        ...
        Example:
            >>> step = client.workflows.get_step_execution(
            ...     execution_id="be42ad95-...",
