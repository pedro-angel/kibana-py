...
def _csv_bytes(file: bytes | str) -> bytes:
    """Normalize a CSV upload payload to bytes.

    :param file: CSV content as ``bytes`` or ``str``
    :return: CSV-encoded bytes
    """
...
def _build_csv_multipart_body(
    file: bytes,
    *,
    filename: str = "upload.csv",
) -> tuple[bytes, str]:
    """Build a ``multipart/form-data`` body for the CSV upload APIs.

    Used by the privileged-user-monitoring and watchlist CSV upload
    endpoints, which expect a single ``file`` form field containing CSV.

    :param file: CSV file content for the ``file`` form field
...
class EntityAnalyticsClient(NamespaceClient):
    ...
    Example:
        ...
        >>> client.entity_analytics.install_entity_store(entity_types=["host"])
    ...
    def create_asset_criticality(
        ...
        *,
        ...
        Example:
            >>> record = client.entity_analytics.create_asset_criticality(
            ...     id_field="host.name",
            ...     id_value="my-host",
            ...     criticality_level="high_impact",
            ...     refresh="wait_for",
        ...
        path = self._build_space_path(
            "/api/asset_criticality", space_id, validate_spaces
        )
    ...
    def bulk_upsert_asset_criticality(
        self,
        *,
        ...
        Example:
            >>> result = client.entity_analytics.bulk_upsert_asset_criticality(
            ...     records=[
            ...         {
            ...             "id_field": "host.name",
            ...             "id_value": "my-host",
        ...
        """
        path = self._build_space_path(
            "/api/asset_criticality/bulk", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def find_asset_criticality(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/asset_criticality/list", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def schedule_risk_engine_now(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/risk_score/engine/schedule_now", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def configure_risk_engine_saved_object(
        self,
        *,
        ...
        path = self._build_space_path(
            "/api/risk_score/engine/saved_object/configure", space_id, validate_spaces
        )
        return self.perform_request(
            "PATCH",
            path,
    ...
    def init_monitoring_engine(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/entity_analytics/monitoring/engine/init", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def schedule_monitoring_engine_now(
        self,
        *,
        space_id: str | None = None,
        validate_spaces: bool | None = None,
        ...
        Example:
            >>> result = client.entity_analytics.schedule_monitoring_engine_now()
            >>> print(result.body["success"])
            True
        """
        path = self._build_space_path(
    ...
    def create_monitored_user(
        ...
        *,
        ...
        Example:
            >>> user = client.entity_analytics.create_monitored_user(
            ...     name="admin-user"
            ... )
        ...
        path = self._build_space_path(
            "/api/entity_analytics/monitoring/users", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def update_monitored_user(
        ...
        *,
        ...
        Example:
            >>> updated = client.entity_analytics.update_monitored_user(
        ...
        """
        path = self._build_space_path(
            f"/api/entity_analytics/monitoring/users/{_quote(id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def delete_monitored_user(
        ...
        *,
        ...
        Example:
            >>> result = client.entity_analytics.delete_monitored_user(
            ...     id="OflsOZ8BiXLbCmmNbJ9J"
            ... )
    ...
    def list_monitored_users(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/entity_analytics/monitoring/users/list", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def upload_monitored_users_csv(
        self,
        *,
        file: bytes | str,
        ...
        path = self._build_space_path(
            "/api/entity_analytics/monitoring/users/_csv", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_pad_status(
        ...
        *,
        ...
        Example:
            >>> status = client.entity_analytics.get_pad_status()
    ...
    def create_watchlist(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/entity_analytics/watchlists", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def list_watchlists(
        ...
        *,
        ...
        Example:
            >>> watchlists = client.entity_analytics.list_watchlists()
            >>> for watchlist in watchlists.body:
            ...     print(watchlist["name"], watchlist["riskModifier"])
        """
        path = self._build_space_path(
            "/api/entity_analytics/watchlists/list", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_watchlist(
        ...
        *,
        ...
        Example:
            >>> watchlist = client.entity_analytics.get_watchlist(
            ...     id="b8b48d31-3026-45c0-aa8a-b8ed7f86ade8"
            ... )
            >>> print(watchlist.body["name"])
        """
        path = self._build_space_path(
            f"/api/entity_analytics/watchlists/{_quote(id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def update_watchlist(
        ...
        *,
        ...
        Example:
            >>> updated = client.entity_analytics.update_watchlist(
            ...     id="b8b48d31-3026-45c0-aa8a-b8ed7f86ade8",
            ...     name="High Risk Vendors",
            ...     risk_modifier=1.8,
            ... )
    ...
    def delete_watchlist(
        ...
        *,
        ...
        Example:
            >>> result = client.entity_analytics.delete_watchlist(
            ...     id="b8b48d31-3026-45c0-aa8a-b8ed7f86ade8"
            ... )
            >>> print(result.body["deleted"])
            True
    ...
    def unassign_watchlist_entities(
        self,
        *,
        watchlist_id: str,
        euids: list[str],
        ...
        Example:
            >>> result = client.entity_analytics.unassign_watchlist_entities(
            ...     watchlist_id="b8b48d31-3026-45c0-aa8a-b8ed7f86ade8",
            ...     euids=["host:web-01"],
            ... )
            >>> print(result.body["successful"])
    ...
    def install_entity_store(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/security/entity_store/install", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def uninstall_entity_store(
        ...
        *,
        ...
        Example:
            >>> result = client.entity_analytics.uninstall_entity_store()
            >>> print(result.body["ok"])
            True
        """
        body: dict[str, Any] = {}
        ...
        path = self._build_space_path(
            "/api/security/entity_store/uninstall", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def update_entity_store(
        ...
        *,
        ...
        Example:
            >>> result = client.entity_analytics.update_entity_store(
        ...
        """
        path = self._build_space_path(
            "/api/security/entity_store", space_id, validate_spaces
        )
        return self.perform_request(
            "PUT",
            path,
    ...
    def get_entity_store_status(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/security/entity_store/status", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def start_entity_store(
        ...
        *,
        ...
        Example:
            >>> result = client.entity_analytics.start_entity_store()
            >>> print(result.body["ok"])
            True
        """
        body: dict[str, Any] = {}
        ...
        path = self._build_space_path(
            "/api/security/entity_store/start", space_id, validate_spaces
        )
        return self.perform_request(
            "PUT",
            path,
    ...
    def stop_entity_store(
        ...
        *,
        ...
        Example:
            >>> result = client.entity_analytics.stop_entity_store()
            >>> print(result.body["ok"])
            True
        """
        body: dict[str, Any] = {}
        ...
        path = self._build_space_path(
            "/api/security/entity_store/stop", space_id, validate_spaces
        )
        return self.perform_request(
            "PUT",
            path,
    ...
    def list_entities(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/security/entity_store/entities", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def create_entity(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/security/entity_store/entities/{_quote(entity_type)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def update_entity(
        ...
        *,
        ...
        Example:
            >>> result = client.entity_analytics.update_entity(
            ...     entity_type="host",
            ...     document={
            ...         "host": {"name": "web-01"},
            ...         "labels": {"env": "prod"},
    ...
    def bulk_update_entities(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/security/entity_store/entities/bulk", space_id, validate_spaces
        )
        return self.perform_request(
            "PUT",
            path,
    ...
    def delete_entity(
        ...
        *,
        ...
        Example:
            >>> result = client.entity_analytics.delete_entity(
    ...
    def get_entity_resolution_group(
        self,
        *,
        entity_id: str,
        space_id: str | None = None,
        ...
        """
        path = self._build_space_path(
            "/api/security/entity_store/resolution/group", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def link_entities(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/security/entity_store/resolution/link", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def unlink_entities(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/security/entity_store/resolution/unlink", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
