"""Kibana Security Attack Discovery API client."""
...
class AttackDiscoveryClient(NamespaceClient):
    ...
    def find(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/attack_discovery/_find", space_id, validate_spaces
        )
    ...
    def bulk_update(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/attack_discovery/_bulk", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def generate(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/attack_discovery/_generate", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_generations(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/attack_discovery/generations", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_generation(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/attack_discovery/generations/{_quote(execution_uuid)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def create_schedule(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/attack_discovery/schedules", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_schedule(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/attack_discovery/schedules/{_quote(id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def enable_schedule(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/attack_discovery/schedules/{_quote(id)}/_enable",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def disable_schedule(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/attack_discovery/schedules/{_quote(id)}/_disable",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def find_schedules(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/attack_discovery/schedules/_find", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
