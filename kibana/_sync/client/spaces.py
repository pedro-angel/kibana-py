...
class SpacesClient(NamespaceClient):
    ...
    def create(
        ...
        *,
        ...
        Example:
            ...
            >>> space = client.spaces.create(id="engineering", name="Engineering")
            >>>
    ...
    def get_all(
        ...
        *,
        ...
        Example:
            ...
            >>> spaces = client.spaces.get_all(purpose="copySavedObjectsIntoSpace")
        """
        params: dict[str, Any] = {}
    ...
    def update(
        ...
        *,
        ...
        Example:
            ...
            >>> current = client.spaces.get(id="marketing").body
    ...
    def resolve_copy_saved_objects_errors(
        self,
        *,
    ...
    def disable_legacy_url_aliases(
        self,
        *,
        ...
        Example:
            >>> client.spaces.disable_legacy_url_aliases(
            ...     aliases=[
            ...         {
