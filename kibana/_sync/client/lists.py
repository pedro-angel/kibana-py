"""Kibana Security Lists API client."""
...
class ListsClient(NamespaceClient):
    ...
    def create(
        ...
        *,
        ...
        path = self._build_space_path("/api/lists", space_id, validate_spaces)
    ...
    def find(
        ...
        *,
        ...
        path = self._build_space_path("/api/lists/_find", space_id, validate_spaces)
        return self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    def create_index(
        ...
        *,
        ...
        Example:
            ...
            True
        """
        path = self._build_space_path("/api/lists/index", space_id, validate_spaces)
        return self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    def create_item(
        ...
        *,
        ...
        path = self._build_space_path("/api/lists/items", space_id, validate_spaces)
        return self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    def find_items(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/lists/items/_find", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def export_items(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/lists/items/_export", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def import_items(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/lists/items/_import", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_privileges(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/lists/privileges", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
