...
class DataViewsClient(NamespaceClient):
    ...
    def get_all(
        ...
        *,
        ...
        """
        path = self._build_space_path("/api/data_views", space_id, validate_spaces)
    ...
    def create(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/data_views/data_view", space_id, validate_spaces
        )
    ...
    def get(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/data_views/data_view/{_quote(view_id)}", space_id, validate_spaces
        )
        return self.perform_request("GET", path)
    ...
    def create_or_update_runtime_field(
        self,
        *,
        view_id: str,
        name: str,
    ...
    def get_default(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/data_views/default", space_id, validate_spaces
        )
        return self.perform_request("GET", path)
    ...
    def swap_references(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/data_views/swap_references", space_id, validate_spaces
        )
        return self.perform_request("POST", path, body=body)

    def preview_swap_references(
        self,
        *,
        from_id: str,
        to_id: str,
        ...
        path = self._build_space_path(
            "/api/data_views/swap_references/_preview", space_id, validate_spaces
        )
        return self.perform_request("POST", path, body=body)
