"""Kibana Security AI Assistant API client."""
...
class SecurityAiAssistantClient(NamespaceClient):
    ...
    def find_prompts(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/security_ai_assistant/prompts/_find", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def bulk_action_anonymization_fields(
        self,
        *,
        create: list[dict[str, Any]] | None = None,
        update: list[dict[str, Any]] | None = None,
    ...
    def find_knowledge_base_entries(
        self,
        *,
        fields: list[str] | None = None,
        filter: str | None = None,
    ...
    def bulk_action_knowledge_base_entries(
        self,
        *,
        create: list[dict[str, Any]] | None = None,
        update: list[dict[str, Any]] | None = None,
    ...
    def chat_complete(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/security_ai_assistant/chat/complete", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
