"""Kibana Fleet Elastic Package Manager (EPM) API client."""
...
class FleetEpmClient(NamespaceClient):
    ...
    Example:
        ...
        >>> client.fleet_epm.get_categories()
        >>> client.fleet_epm.install_package(pkg_name="tcp", pkg_version="2.3.1")
        >>>
        >>> # Inspect and uninstall it again
        >>> pkg = client.fleet_epm.get_package(pkg_name="tcp")
        >>> print(pkg.body["item"]["status"])
        installed
        >>> client.fleet_epm.uninstall_package(pkg_name="tcp")
    """
    ...
    def get_categories(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/epm/categories", space_id, validate_spaces
        )
    ...
    def get_packages(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/epm/packages", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_installed_packages(
        ...
        *,
        ...
        Example:
            >>> installed = client.fleet_epm.get_installed_packages(per_page=10)
        ...
        path = self._build_space_path(
            "/api/fleet/epm/packages/installed", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_limited_packages(
        ...
        *,
        ...
        Example:
            >>> limited = client.fleet_epm.get_limited_packages()
            >>> print(limited.body["items"])
            []
        """
        path = self._build_space_path(
            "/api/fleet/epm/packages/limited", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_package_stats(
        ...
        *,
        ...
        Example:
            >>> stats = client.fleet_epm.get_package_stats(pkg_name="tcp")
            >>> print(stats.body["response"]["package_policy_count"])
            0
        """
        path = self._build_space_path(
            f"/api/fleet/epm/packages/{_quote(pkg_name)}/stats",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_verification_key_id(
        ...
        *,
        ...
        Example:
            >>> key = client.fleet_epm.get_verification_key_id()
            >>> print(key.body["id"])
            d27d666cd88e42b4
        """
        path = self._build_space_path(
            "/api/fleet/epm/verification_key_id", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def install_package(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_epm.install_package(
            ...     pkg_name="tcp", pkg_version="2.3.1"
            ... )
    ...
    def update_package(
        ...
        *,
        ...
        Example:
            >>> updated = client.fleet_epm.update_package(
    ...
    def uninstall_package(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_epm.uninstall_package(pkg_name="tcp")
    ...
    def rollback_package(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/epm/packages/{_quote(pkg_name)}/rollback",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def review_upgrade(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/fleet/epm/packages/{_quote(pkg_name)}/review_upgrade",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def bulk_install_packages(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/epm/packages/_bulk", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def bulk_upgrade_packages(
        ...
        *,
        ...
        Example:
            >>> started = client.fleet_epm.bulk_upgrade_packages(packages=["tcp"])
        ...
        path = self._build_space_path(
            "/api/fleet/epm/packages/_bulk_upgrade", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_bulk_upgrade_status(
        ...
        *,
        ...
        Example:
            >>> status = client.fleet_epm.get_bulk_upgrade_status(task_id=task_id)
            >>> print(status.body["status"])
            success
        """
        path = self._build_space_path(
            f"/api/fleet/epm/packages/_bulk_upgrade/{_quote(task_id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def bulk_uninstall_packages(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/epm/packages/_bulk_uninstall", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_bulk_uninstall_status(
        ...
        *,
        ...
        Example:
            >>> status = client.fleet_epm.get_bulk_uninstall_status(task_id=task_id)
            >>> print(status.body["status"])
            success
        """
        path = self._build_space_path(
            f"/api/fleet/epm/packages/_bulk_uninstall/{_quote(task_id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def bulk_rollback_packages(
        ...
        *,
        ...
        Example:
            >>> started = client.fleet_epm.bulk_rollback_packages(packages=["tcp"])
            >>> task_id = started.body["taskId"]
        """
        body: dict[str, Any] = {"packages": _normalize_name_items(packages)}

        path = self._build_space_path(
            "/api/fleet/epm/packages/_bulk_rollback", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_bulk_rollback_status(
        ...
        *,
        ...
        Example:
            >>> status = client.fleet_epm.get_bulk_rollback_status(task_id=task_id)
            >>> print(status.body["status"])
            success
        """
        path = self._build_space_path(
            f"/api/fleet/epm/packages/_bulk_rollback/{_quote(task_id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def bulk_get_assets(
        ...
        *,
        ...
        Example:
            >>> assets = client.fleet_epm.bulk_get_assets(
        ...
        path = self._build_space_path(
            "/api/fleet/epm/bulk_assets", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def install_kibana_assets(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_epm.install_kibana_assets(
            ...     pkg_name="tcp", pkg_version="2.3.1"
            ... )
            >>> print(result.body["success"])
            True
    ...
    def delete_kibana_assets(
        ...
        *,
        ...
        Example:
            >>> client.fleet_epm.delete_kibana_assets(
    ...
    def install_rule_assets(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_epm.install_rule_assets(
            ...     pkg_name="tcp", pkg_version="2.3.1"
            ... )
            >>> print(result.body["success"])
            True
    ...
    def authorize_transforms(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_epm.authorize_transforms(
    ...
    def create_custom_integration(
        ...
        *,
        ...
        Example:
            >>> created = client.fleet_epm.create_custom_integration(
        ...
        path = self._build_space_path(
            "/api/fleet/epm/custom_integrations", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def update_custom_integration(
        ...
        *,
        ...
        Example:
            >>> updated = client.fleet_epm.update_custom_integration(
        ...
        path = self._build_space_path(
            f"/api/fleet/epm/custom_integrations/{_quote(pkg_name)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_data_streams(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/fleet/data_streams", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def find_data_streams(
        ...
        *,
        ...
        Example:
            >>> streams = client.fleet_epm.find_data_streams(type="logs")
        ...
        path = self._build_space_path(
            "/api/fleet/epm/data_streams", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
