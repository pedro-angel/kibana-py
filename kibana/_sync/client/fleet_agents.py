"""Kibana Fleet Elastic Agents API client."""
...
class FleetAgentsClient(NamespaceClient):
    ...
    Example:
        ...
        >>> agents = client.fleet_agents.get_all(per_page=50)
    ...
    def get_status(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/agent_status", space_id, validate_spaces
        )
    ...
    def get_incoming_data(
        ...
        *,
        ...
        Example:
            >>> data = client.fleet_agents.get_incoming_data(
        ...
        path = self._build_space_path(
            "/api/fleet/agent_status/data", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_all(
        ...
        *,
        ...
        path = self._build_space_path("/api/fleet/agents", space_id, validate_spaces)
        return self.perform_request(
            "GET",
            path,
            params=params or None,
    ...
    def get_by_actions(
        ...
        *,
        ...
        Example:
            >>> agents = client.fleet_agents.get_by_actions(
    ...
    def get(
        ...
        *,
        ...
        Example:
            >>> agent = client.fleet_agents.get(agent_id="agent-id-1")
        ...
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def update(
        ...
        *,
        ...
        Example:
            >>> updated = client.fleet_agents.update(
    ...
    def create_action(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_agents.create_action(
            ...     agent_id="agent-id-1",
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/actions", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_effective_config(
        ...
        *,
        ...
        Example:
            >>> config = client.fleet_agents.get_effective_config(
            ...     agent_id="agent-id-1"
            ... )
        """
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/effective_config",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def migrate(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/migrate", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def change_privilege_level(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/privilege_level_change",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def reassign(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/reassign", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def request_diagnostics(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/request_diagnostics",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def rollback(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/rollback", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def unenroll(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/unenroll", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def upgrade(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/upgrade", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_uploads(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/agents/{_quote(agent_id)}/uploads", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_action_status(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/agents/action_status", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def cancel_action(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_agents.cancel_action(
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/agents/actions/{_quote(action_id)}/cancel",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_available_versions(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/fleet/agents/available_versions", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def bulk_migrate(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/agents/bulk_migrate", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def bulk_change_privilege_level(
        self,
        *,
        agents: list[str] | str,
        user_info: dict[str, Any] | None = None,
        ...
        Example:
            >>> result = client.fleet_agents.bulk_change_privilege_level(
            ...     agents=["agent-id-1", "agent-id-2"],
            ...     user_info={"username": "elastic-agent-user"},
            ... )
            >>> print(result.body["actionId"])
        ...
        path = self._build_space_path(
            "/api/fleet/agents/bulk_privilege_level_change", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def bulk_reassign(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_agents.bulk_reassign(
        ...
        path = self._build_space_path(
            "/api/fleet/agents/bulk_reassign", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def bulk_request_diagnostics(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_agents.bulk_request_diagnostics(
            ...     agents=["agent-id-1", "agent-id-2"],
        ...
        path = self._build_space_path(
            "/api/fleet/agents/bulk_request_diagnostics", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def bulk_rollback(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/agents/bulk_rollback", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def bulk_unenroll(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_agents.bulk_unenroll(
        ...
        path = self._build_space_path(
            "/api/fleet/agents/bulk_unenroll", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def bulk_update_tags(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_agents.bulk_update_tags(
            ...     agents=["agent-id-1", "agent-id-2"],
        ...
        path = self._build_space_path(
            "/api/fleet/agents/bulk_update_agent_tags", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def bulk_upgrade(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/agents/bulk_upgrade", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_file(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/agents/files/{_quote(file_id)}/{_quote(file_name)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def delete_file(
        ...
        *,
        ...
        Example:
            >>> result = client.fleet_agents.delete_file(file_id="file-id-1")
            >>> print(result.body["deleted"])
            True
        """
        path = self._build_space_path(
            f"/api/fleet/agents/files/{_quote(file_id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "DELETE",
            path,
    ...
    def get_setup_status(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/fleet/agents/setup", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_tags(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/agents/tags", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
