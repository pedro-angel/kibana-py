"""Kibana Fleet outputs and connectivity API client."""
...
class FleetOutputsClient(NamespaceClient):
    ...
    def get_outputs(
        ...
        *,
        ...
        """
        path = self._build_space_path("/api/fleet/outputs", space_id, validate_spaces)
    ...
    def get_output(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/fleet/outputs/{_quote(output_id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_output_health(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/outputs/{_quote(output_id)}/health",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_fleet_server_hosts(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/fleet/fleet_server_hosts", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_fleet_server_host(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/fleet_server_hosts/{_quote(item_id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_proxies(
        ...
        *,
        ...
        """
        path = self._build_space_path("/api/fleet/proxies", space_id, validate_spaces)
        return self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    def get_proxy(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/proxies/{_quote(item_id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_agent_download_sources(
        self,
        *,
        space_id: str | None = None,
        validate_spaces: bool | None = None,
        ...
        """
        path = self._build_space_path(
            "/api/fleet/agent_download_sources", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_agent_download_source(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/agent_download_sources/{_quote(source_id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def update_agent_download_source(
        self,
        *,
        source_id: str,
        name: str,
    ...
    def delete_agent_download_source(
        self,
        *,
        source_id: str,
        space_id: str | None = None,
    ...
    def get_remote_synced_integrations_status(
        self,
        *,
        space_id: str | None = None,
        validate_spaces: bool | None = None,
    ...
    def get_remote_synced_integrations_remote_status(
        self,
        *,
        output_id: str,
        space_id: str | None = None,
    ...
    def get_cloud_connectors(
        ...
        *,
        ...
        if kuery is not None:
            params["kuery"] = kuery
        path = self._build_space_path(
            "/api/fleet/cloud_connectors", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_cloud_connector(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/fleet/cloud_connectors/{_quote(cloud_connector_id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_cloud_connector_usage(
        ...
        *,
        ...
        if per_page is not None:
            params["perPage"] = per_page
        path = self._build_space_path(
            f"/api/fleet/cloud_connectors/{_quote(cloud_connector_id)}/usage",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
