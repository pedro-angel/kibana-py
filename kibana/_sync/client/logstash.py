...
class LogstashClient(NamespaceClient):
    ...
    def get_all(self) -> ObjectApiResponse[Any]:
    ...
    def get(self, *, id: str) -> ObjectApiResponse[Any]:
    ...
    def delete(self, *, id: str) -> ObjectApiResponse[Any]:
