"""Kibana Security Endpoint Management API client."""
...
class EndpointClient(NamespaceClient):
    ...
    def get_metadata_list(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/metadata", space_id, validate_spaces
        )
    ...
    def get_metadata(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/endpoint/metadata/{_quote(id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_actions_list(
        ...
        *,
        ...
        path = self._build_space_path("/api/endpoint/action", space_id, validate_spaces)
        return self.perform_request(
            "GET",
            path,
            params=params,
    ...
    def get_actions_status(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action_status", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_action_details(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/endpoint/action/{_quote(action_id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_actions_state(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            "/api/endpoint/action/state", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def isolate(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/isolate", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def unisolate(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/unisolate", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def kill_process(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/kill_process", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def suspend_process(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/suspend_process", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_running_processes(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/running_procs", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_file(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/get_file", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def execute(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/execute", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def scan(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/scan", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def generate_memory_dump(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/memory_dump", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def run_script(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/run_script", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def cancel(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/cancel", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def upload(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/action/upload", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_policy_response(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/policy_response", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    # ------------------------------------------------------------------
    def get_protection_updates_note(
        self,
        *,
    ...
    def create_update_protection_updates_note(
        self,
        *,
        package_policy_id: str,
        note: str | None = None,
    ...
    def get_scripts(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint/scripts_library", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_script(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/endpoint/scripts_library/{_quote(script_id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def download_script(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/endpoint/scripts_library/{_quote(script_id)}/download",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
