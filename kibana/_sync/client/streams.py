...
class StreamsClient(NamespaceClient):
    ...
    def enable(
        ...
        *,
        ...
        Example:
            ...
            True
        """
        path = self._build_space_path("/api/streams/_enable", space_id, validate_spaces)
    ...
    def disable(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/streams/_disable", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def resync(
        ...
        *,
        ...
        """
        path = self._build_space_path("/api/streams/_resync", space_id, validate_spaces)
        return self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    def get_all(
        ...
        *,
        ...
        Example:
            ...
            ['logs.ecs', 'logs.otel']
        """
        path = self._build_space_path("/api/streams", space_id, validate_spaces)
        return self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    def get(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def upsert(
        ...
        *,
        ...
        elif self._capability_available("streams.upsert.queries"):
            body["queries"] = []
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}", space_id, validate_spaces
        )
    ...
    def fork(
        ...
        *,
        ...
        if status is not None:
            body["status"] = status
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/_fork", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_ingest(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/_ingest", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_query_settings(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/_query", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_queries(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/queries", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def bulk_queries(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/queries/_bulk", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def upsert_query(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/queries/{_quote(query_id)}",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def get_significant_events(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/significant_events",
            space_id,
            validate_spaces,
        )
    ...
    def generate_significant_events(
        self,
        *,
        name: str,
        from_: str,
        ...
        Example:
            ...
            ... )
        """
        self._require_capability("streams.generate_significant_events")
        params: dict[str, Any] = {
            "from": from_,
            "to": to,
        }
        ...
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/significant_events/_generate",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def preview_significant_events(
        self,
        *,
        name: str,
        from_: str,
        ...
        Example:
            ...
            ... )
        """
        self._require_capability("streams.preview_significant_events")
        params: dict[str, Any] = {
            "from": from_,
            "to": to,
            "bucketSize": bucket_size,
        ...
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/significant_events/_preview",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def export_content(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/content/export",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def import_content(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/content/import",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
    ...
    def bulk_attachments(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/streams/{_quote(name)}/attachments/_bulk",
            space_id,
            validate_spaces,
        )
        return self.perform_request(
