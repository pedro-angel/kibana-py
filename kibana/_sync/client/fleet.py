"""Kibana Fleet core API (setup, settings, health) client."""
...
class FleetClient(NamespaceClient):
    """Client for the Kibana Fleet core API (setup, settings, health).
    ...
    def setup(
        ...
        *,
        ...
        Example:
            ...
            []
        """
        path = self._build_space_path("/api/fleet/setup", space_id, validate_spaces)
    ...
    def get_settings(
        ...
        *,
        ...
        Example:
            ...
            False
        """
        path = self._build_space_path("/api/fleet/settings", space_id, validate_spaces)
        return self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    def update_settings(
        ...
        *,
        ...
        Example:
            >>> updated = client.fleet.update_settings(
    ...
    def get_space_settings(
        ...
        *,
        ...
        Example:
            >>> settings = client.fleet.get_space_settings()
            >>> print(settings.body["item"]["allowed_namespace_prefixes"])
            []
        """
        path = self._build_space_path(
            "/api/fleet/space_settings", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def update_space_settings(
        ...
        *,
        ...
        Example:
            >>> updated = client.fleet.update_space_settings(
    ...
    def health_check(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/health_check", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def check_permissions(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/fleet/check-permissions", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
