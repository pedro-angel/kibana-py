"""Kibana Security Osquery API client."""
...
class OsqueryClient(NamespaceClient):
    ...
    def create_pack(
        ...
        *,
        ...
        path = self._build_space_path("/api/osquery/packs", space_id, validate_spaces)
    ...
    def get_pack(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/osquery/packs/{_quote(id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def create_saved_query(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/osquery/saved_queries", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_saved_query(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/osquery/saved_queries/{_quote(id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def create_live_query(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/osquery/live_queries", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_live_query(
        ...
        *,
        ...
        """
        path = self._build_space_path(
            f"/api/osquery/live_queries/{_quote(id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
