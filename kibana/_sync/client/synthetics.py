...
class SyntheticsClient(NamespaceClient):
    ...
    def get_monitors(
        ...
        *,
        ...
        Example:
            >>> response = client.synthetics.get_monitors(
        ...
        path = self._build_space_path(
            "/api/synthetics/monitors", space_id, validate_spaces
        )
    ...
    def get_monitor(
        ...
        *,
        ...
        Example:
            >>> monitor = client.synthetics.get_monitor(id="d4ba9d2f-...")
            >>> print(monitor.body["name"], monitor.body["type"])
        """
        path = self._build_space_path(
            f"/api/synthetics/monitors/{_quote(id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def update_monitor(
        ...
        *,
        ...
        Example:
            >>> updated = client.synthetics.update_monitor(
            ...     id="d4ba9d2f-...",
    ...
    def delete_monitor(
        ...
        *,
        ...
        Example:
            >>> result = client.synthetics.delete_monitor(id="d4ba9d2f-...")
    ...
    def bulk_delete_monitors(
        ...
        *,
        ...
        Example:
            >>> result = client.synthetics.bulk_delete_monitors(
            ...     ids=["id-1", "id-2"]
            ... )
        ...
        """
        path = self._build_space_path(
            "/api/synthetics/monitors/_bulk_delete", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def test_monitor(
        ...
        *,
        ...
        Example:
            >>> run = client.synthetics.test_monitor(monitor_id="d4ba9d2f-...")
    ...
    def get_params(
        ...
        *,
        ...
        Example:
            >>> response = client.synthetics.get_params()
            >>> for param in response.body:
            ...     print(param["key"])
        """
        path = self._build_space_path(
            "/api/synthetics/params", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_param(
        ...
        *,
        ...
        Example:
            >>> param = client.synthetics.get_param(id="a1b2c3")
            >>> print(param.body["key"])
        """
        path = self._build_space_path(
            f"/api/synthetics/params/{_quote(id)}", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def bulk_create_params(
        ...
        *,
        ...
        Example:
            >>> created = client.synthetics.bulk_create_params(
            ...     parameters=[
    ...
    def update_param(
        ...
        *,
        ...
        Example:
            >>> updated = client.synthetics.update_param(
    ...
    def delete_param(
        ...
        *,
        ...
        Example:
            >>> result = client.synthetics.delete_param(id="a1b2c3")
            >>> print(result.body[0]["deleted"])
            True
        """
        path = self._build_space_path(
    ...
    def bulk_delete_params(
        ...
        *,
        ...
        Example:
            >>> result = client.synthetics.bulk_delete_params(
            ...     ids=["id-1", "id-2"]
            ... )
        ...
        """
        path = self._build_space_path(
            "/api/synthetics/params/_bulk_delete", space_id, validate_spaces
        )
        return self.perform_request(
            "POST",
            path,
    ...
    def get_private_locations(
        ...
        *,
        ...
        Example:
            >>> response = client.synthetics.get_private_locations()
            >>> for location in response.body:
            ...     print(location["label"], location["id"])
        """
        path = self._build_space_path(
            "/api/synthetics/private_locations", space_id, validate_spaces
        )
        return self.perform_request(
            "GET",
            path,
    ...
    def get_private_location(
        ...
        *,
        ...
        Example:
            >>> location = client.synthetics.get_private_location(
            ...     id="e3134290-..."
            ... )
    ...
    def update_private_location(
        ...
        *,
        ...
        Example:
            >>> updated = client.synthetics.update_private_location(
