"""Kibana Security Exceptions API client."""
...
class ExceptionListsClient(NamespaceClient):
    ...
    def create(
        ...
        *,
        ...
        path = self._build_space_path("/api/exception_lists", space_id, validate_spaces)
    ...
    def delete(
        ...
        *,
        ...
        path = self._build_space_path("/api/exception_lists", space_id, validate_spaces)
        return self.perform_request("DELETE", path, params=params)
    ...
    def find(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/exception_lists/_find", space_id, validate_spaces
        )
        return self.perform_request("GET", path, params=params if params else None)
    ...
    def duplicate(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/exception_lists/_duplicate", space_id, validate_spaces
        )
        return self.perform_request("POST", path, params=params)
    ...
    def export(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/exception_lists/_export", space_id, validate_spaces
        )
        return self.perform_request("POST", path, params=params)
    ...
    def import_lists(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/exception_lists/_import", space_id, validate_spaces
        )
    ...
    def get_summary(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/exception_lists/summary", space_id, validate_spaces
        )
        return self.perform_request("GET", path, params=params)
    ...
    def create_item(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/exception_lists/items", space_id, validate_spaces
        )
        return self.perform_request("POST", path, body=body)
    ...
    def find_items(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/exception_lists/items/_find", space_id, validate_spaces
        )
        return self.perform_request("GET", path, params=params)
    ...
    def create_shared_list(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/exceptions/shared", space_id, validate_spaces
        )
        return self.perform_request("POST", path, body=body)

    def create_rule_exceptions(
        self,
        *,
        id: str,
        ...
        path = self._build_space_path(
            f"/api/detection_engine/rules/{_quote(id)}/exceptions",
            space_id,
            validate_spaces,
        )
        return self.perform_request("POST", path, body=body)
    ...
    def create_endpoint_list(
        ...
        *,
        ...
        """
        path = self._build_space_path("/api/endpoint_list", space_id, validate_spaces)
        return self.perform_request("POST", path)

    def create_endpoint_item(
        self,
        *,
        name: str,
        description: str,
        ...
        path = self._build_space_path(
            "/api/endpoint_list/items", space_id, validate_spaces
        )
        return self.perform_request("POST", path, body=body)

    def get_endpoint_item(
        self,
        *,
        id: str | None = None,
        item_id: str | None = None,
    ...
    def find_endpoint_items(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/endpoint_list/items/_find", space_id, validate_spaces
        )
        return self.perform_request("GET", path, params=params if params else None)
