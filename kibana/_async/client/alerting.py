...
class AsyncRulesClient(AsyncNamespaceClient):
    ...
    async def find(
        ...
        *,
        ...
        return await self.perform_request("GET", path, params=params or None)
    ...
    async def enable(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/alerting/rule/{_quote(id)}/_enable", space_id
        )
    ...
    async def disable(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/alerting/rule/{_quote(id)}/_disable", space_id
        )
        return await self.perform_request("POST", path, body=body)
    ...
    async def mute_all(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/alerting/rule/{_quote(id)}/_mute_all", space_id
        )
        return await self.perform_request("POST", path)
    ...
    async def unmute_all(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/alerting/rule/{_quote(id)}/_unmute_all", space_id
        )
        return await self.perform_request("POST", path)
    ...
    async def snooze(
        ...
        *,
        ...
        return await self.perform_request("POST", path, body={"schedule": schedule})
    ...
    async def mute_alert(
        ...
        *,
        ...
        return await self.perform_request("POST", path, params=params or None)
...
class AsyncBackfillClient(AsyncNamespaceClient):
    ...
    async def schedule(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/alerting/rules/backfill/_schedule", space_id
        )
        return await self.perform_request("POST", path, body=body)
    ...
    async def find(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/alerting/rules/backfill/_find", space_id)
        return await self.perform_request("POST", path, params=params or None)
    ...
    async def get(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/alerting/rules/backfill/{_quote(id)}", space_id
        )
        return await self.perform_request("GET", path)
...
class AsyncAlertingClient(AsyncNamespaceClient):
    ...
    def __init__(
        ...
        self._rule = AsyncRulesClient(
            client,
            default_space_id=default_space_id,
            validate_spaces=validate_spaces,
        )
        self._backfill = AsyncBackfillClient(
            client,
            default_space_id=default_space_id,
            validate_spaces=validate_spaces,
        )
    ...
    @property
    def backfill(self) -> AsyncBackfillClient:
    ...
    async def health(
        ...
        *,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/alerting/_health", space_id)
        return await self.perform_request("GET", path)
    ...
    async def rule_types(
        ...
        *,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/alerting/rule_types", space_id)
        return await self.perform_request("GET", path)
