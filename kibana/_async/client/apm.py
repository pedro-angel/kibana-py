...
class AsyncApmClient(AsyncNamespaceClient):
    """Async client for the Kibana APM (Application Performance Monitoring) API.
    ...
    Example:
        ...
        >>> for c in configs.body["configurations"]:
    ...
    async def create_agent_key(
        ...
        *,
        ...
        Example:
            >>> response = await client.apm.create_agent_key(
            ...     name="my-agent-key",
        ...
        path = self._build_space_path("/api/apm/agent_keys", space_id)
    ...
    async def save_server_schema(
        ...
        *,
        ...
        Example:
            >>> await client.apm.save_server_schema(
            ...     schema={"apm-server.host": "0.0.0.0:8200"}
            ... )
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/apm/fleet/apm_server_schema", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def create_annotation(
        ...
        *,
        ...
        Example:
            >>> response = await client.apm.create_annotation(
    ...
    async def search_annotations(
        ...
        *,
        ...
        Example:
            >>> response = await client.apm.search_annotations(
            ...     service_name="opbeans-java",
    ...
    async def get_agent_configurations(
        ...
        *,
        ...
        Example:
            >>> response = await client.apm.get_agent_configurations()
            >>> for config in response.body["configurations"]:
            ...     print(config["service"], config["settings"])
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/apm/settings/agent-configuration", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    async def create_or_update_agent_configuration(
        self,
        *,
    ...
    async def delete_agent_configuration(
        ...
        *,
        ...
        Example:
            >>> await client.apm.delete_agent_configuration(
            ...     service_name="opbeans-node",
            ...     service_environment="production",
            ... )
        """
    ...
    async def get_agent_configuration(
        ...
        *,
        ...
        Example:
            >>> response = await client.apm.get_agent_configuration(
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/apm/settings/agent-configuration/view", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def search_agent_configurations(
        self,
        *,
        service_name: str | None = None,
        service_environment: str | None = None,
        ...
        Example:
            >>> response = await client.apm.search_agent_configurations(
            ...     service_name="opbeans-node",
            ...     service_environment="production",
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/apm/settings/agent-configuration/search", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def get_environments(
        ...
        *,
        ...
        Example:
            >>> response = await client.apm.get_environments(
            ...     service_name="opbeans-node"
            ... )
    ...
    async def get_agent_name(
        ...
        *,
        ...
        Example:
            >>> response = await client.apm.get_agent_name(
            ...     service_name="opbeans-node"
            ... )
    ...
    async def get_sourcemaps(
        ...
        *,
        ...
        Example:
            >>> response = await client.apm.get_sourcemaps(page=1, per_page=10)
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/apm/sourcemaps", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params if params else None,
    ...
    async def upload_sourcemap(
        ...
        *,
        ...
        Example:
            >>> response = await client.apm.upload_sourcemap(
    ...
    async def delete_sourcemap(
        ...
        *,
        ...
        Example:
            >>> await client.apm.delete_sourcemap(
            ...     id="apm:opbeans-rum-1.2.3-ba48e0ac0c14..."
            ... )
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"/api/apm/sourcemaps/{_quote(id)}", space_id)
        return await self.perform_request(
            "DELETE",
            path,
            headers={"accept": "application/json"},
