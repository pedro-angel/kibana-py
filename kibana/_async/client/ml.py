"""Async Kibana Machine Learning API client."""
...
class AsyncMlClient(AsyncNamespaceClient):
    """Async client for the Kibana Machine Learning API.
    ...
    async def sync(
        ...
        *,
        ...
        Example:
            ...
            >>> result = await client.ml.sync(space_id="marketing")
        """
        params: dict[str, Any] = {}
    ...
    async def update_trained_models_spaces(
        self,
        *,
        model_ids: list[str],
        spaces_to_add: list[str],
