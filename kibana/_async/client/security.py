"""Async Kibana Security (roles and sessions) API client."""
...
class AsyncSecurityClient(AsyncNamespaceClient):
    ...
    async def delete_role(self, *, name: str) -> ObjectApiResponse[Any]:
    ...
    async def bulk_create_or_update_roles(
        self,
        *,
