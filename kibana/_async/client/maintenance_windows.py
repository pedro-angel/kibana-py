"""Async Kibana Maintenance Windows API client."""
...
class AsyncMaintenanceWindowsClient(AsyncNamespaceClient):
    """Async client for the Kibana Maintenance Windows API.
    ...
    Example:
        ...
        >>> await client.maintenance_windows.archive(id=mw_id)
        >>> await client.maintenance_windows.delete(id=mw_id)
    """
    ...
    async def create(
        ...
        *,
        ...
        path = self._build_space_path("/api/maintenance_window", space_id)
    ...
    async def get(
        ...
        *,
        ...
        Example:
            >>> window = await client.maintenance_windows.get(id="da4c2f57-...")
            >>> print(window.body["title"])
            Weekend maintenance
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"/api/maintenance_window/{_quote(id)}", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    async def find(
        ...
        *,
        ...
        Example:
            >>> found = await client.maintenance_windows.find(
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/maintenance_window/_find", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params,
        ...
        *,
        ...
        Args:
            ...
            schedule: The new schedule of the maintenance window; an object
                ...
                :meth:`AsyncMaintenanceWindowsClient.create`).
            scope: An object narrowing the affected rules with a KQL query,
        ...
        Example:
            >>> updated = await client.maintenance_windows.update(
    ...
    async def archive(
        ...
        *,
        ...
        Example:
            >>> archived = await client.maintenance_windows.archive(id="da4c2f57-...")
            >>> print(archived.body["status"])
            archived
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/maintenance_window/{_quote(id)}/_archive", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def unarchive(
        ...
        *,
        ...
        Example:
            >>> restored = await client.maintenance_windows.unarchive(id="da4c2f57-...")
            >>> print(restored.body["status"] != "archived")
            True
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/maintenance_window/{_quote(id)}/_unarchive", space_id
        )
        return await self.perform_request(
            "POST",
            path,
