"""Async Kibana Fleet enrollment keys and tokens API client."""
...
class AsyncFleetEnrollmentClient(AsyncNamespaceClient):
    ...
    async def get_keys(
        ...
        *,
        ...
        path = self._build_space_path("/api/fleet/enrollment_api_keys", space_id)
    ...
    async def get_key(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/fleet/enrollment_api_keys/{_quote(key_id)}", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def create_service_token(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/service_tokens", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def create_logstash_api_key(
        self,
        *,
        space_id: str | None = None,
        validate_spaces: bool | None = None,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/logstash_api_keys", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def get_uninstall_tokens(
        self,
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/uninstall_tokens", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params,
    ...
    async def get_uninstall_token(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/fleet/uninstall_tokens/{_quote(uninstall_token_id)}", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def rotate_message_signing_key_pair(
        self,
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/fleet/message_signing_service/rotate_key_pair", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def get_kubernetes_manifest(
        self,
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/kubernetes", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params,
    ...
    async def download_kubernetes_manifest(
        self,
        *,
        download: bool | None = None,
        fleet_server: str | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/kubernetes/download", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params,
