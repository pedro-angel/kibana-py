"""Async Kibana Short URLs API client."""
...
class AsyncShortUrlsClient(AsyncNamespaceClient):
    ...
    async def create(
        ...
        *,
        ...
        path = self._build_space_path("/api/short_url", space_id)
    ...
    async def get(
        ...
        *,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"/api/short_url/{_quote(id)}", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    async def resolve(
        ...
        *,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"/api/short_url/_slug/{_quote(slug)}", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
