...
class AsyncCasesClient(AsyncNamespaceClient):
    """Async client for the Kibana Cases API.
    ...
    Example:
        ...
        ... )
        >>> updated = await client.cases.update(
        ...     id=case_id, version=case.body["version"], status="closed"
        ... )
        >>> await client.cases.delete(ids=[case_id])
    """
    ...
    async def create(
        ...
        **Management**, **Observability**, or **Security** section of the
        ...
        path = self._build_space_path("/api/cases", space_id)
    ...
    async def get(
        ...
        *,
        ...
        Example:
            >>> case = await client.cases.get(case_id="a18b38a0-...")
            >>> print(case.body["title"])
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"/api/cases/{_quote(case_id)}", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    async def find(
        ...
        *,
        ...
        Example:
            >>> found = await client.cases.find(tags="security", status="open")
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/cases/_find", space_id)
        return await self.perform_request(
            "GET",
            path,
    ...
    async def get_alerts(
        ...
        *,
        ...
        Example:
            >>> alerts = await client.cases.get_alerts(case_id="a18b38a0-...")
            >>> for alert in alerts.body:
            ...     print(alert["id"], alert["index"])
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"/api/cases/{_quote(case_id)}/alerts", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    async def get_cases_by_alert(
        ...
        *,
        ...
        Example:
            >>> cases = await client.cases.get_cases_by_alert(
            ...     alert_id="09f0c261..."
            ... )
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"/api/cases/alerts/{_quote(alert_id)}", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params or None,
    ...
    async def add_comment(
        ...
        *,
        ...
        Example:
            >>> updated = await client.cases.add_comment(
            ...     case_id="a18b38a0-...",
        ...
        path = self._build_space_path(
            f"/api/cases/{_quote(case_id)}/comments", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def update_comment(
        ...
        *,
        ...
        Example:
            >>> updated = await client.cases.update_comment(
            ...     case_id="a18b38a0-...",
            ...     id="8af6ac20-...",
            ...     version="Wzk1LDFd",
    ...
    async def get_comment(
        ...
        *,
        ...
        Example:
            >>> comment = await client.cases.get_comment(
    ...
    async def get_comments(
        ...
        *,
        ...
        Example:
            >>> comments = await client.cases.get_comments(
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/cases/{_quote(case_id)}/comments/_find", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def delete_comment(
        ...
        *,
        ...
        Example:
            >>> await client.cases.delete_comment(
            ...     case_id="a18b38a0-...", comment_id="8af6ac20-..."
            ... )
        """
        await self._maybe_validate_space(space_id, validate_spaces)
    ...
    async def find_user_actions(
        ...
        *,
        ...
        Example:
            >>> activity = await client.cases.find_user_actions(
    ...
    async def push(
        ...
        *,
        ...
        Example:
            >>> pushed = await client.cases.push(
            ...     case_id="a18b38a0-...",
    ...
    async def add_file(
        ...
        *,
        ...
        Example:
            >>> updated = await client.cases.add_file(
            ...     case_id="a18b38a0-...",
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"/api/cases/{_quote(case_id)}/files", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={
    ...
    async def get_configuration(
        ...
        *,
        ...
        Example:
            >>> configs = await client.cases.get_configuration(owner="cases")
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/cases/configure", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params or None,
    ...
    async def create_configuration(
        ...
        *,
        ...
        Example:
            >>> config = await client.cases.create_configuration(
    ...
    async def update_configuration(
        ...
        *,
        ...
        Example:
            >>> updated = await client.cases.update_configuration(
    ...
    async def find_connectors(
        ...
        *,
        ...
        Example:
            >>> connectors = await client.cases.find_connectors()
            >>> for connector in connectors.body:
            ...     print(connector["id"], connector["actionTypeId"])
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/cases/configure/connectors/_find", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    async def get_reporters(
        ...
        *,
        ...
        Example:
            >>> reporters = await client.cases.get_reporters(owner="cases")
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/cases/reporters", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params or None,
    ...
    async def get_tags(
        ...
        *,
        ...
        Example:
            >>> tags = await client.cases.get_tags()
            >>> print(tags.body)
            ['security', 'auth']
        """
        params: dict[str, Any] = {}
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/cases/tags", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params or None,
