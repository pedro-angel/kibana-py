"""AsyncConnectorsClient for managing Kibana connectors (actions)."""
...
class AsyncConnectorsClient(AsyncNamespaceClient):
    """Async client for the Kibana Connectors API (``/api/actions``).
    ...
    Example:
        ...
        >>> connector = await marketing.connectors.create(
        ...     name="Marketing Log",
    ...
    def __init__(
        ...
        Args:
            client: Parent AsyncBaseClient instance to delegate HTTP requests
                to.
    ...
    async def get_oauth_callback_script(
        self,
        *,
        space_id: str | None = None,
        validate_space: bool | None = None,
