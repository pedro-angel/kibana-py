"""Async Kibana Security Detections (detection engine) API client."""
...
class AsyncDetectionEngineClient(AsyncNamespaceClient):
    ...
    async def get_privileges(
        ...
        *,
        ...
        path = self._build_space_path("/api/detection_engine/privileges", space_id)
    ...
    async def create_alerts_index(
        ...
        *,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/index", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def create_rule(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/rules", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def find_rules(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/rules/_find", space_id)
        return await self.perform_request(
            "GET",
            path,
    ...
    async def bulk_action_rules(
        ...
        *,
        ...
        path = self._build_space_path(
            "/api/detection_engine/rules/_bulk_action", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def export_rules(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/rules/_export", space_id)
        return await self.perform_request(
            "POST",
            path,
            params=params if params else None,
    ...
    async def import_rules(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/rules/_import", space_id)
        return await self.perform_request(
            "POST",
            path,
            params=params if params else None,
    ...
    async def get_prepackaged_rules_status(
        self,
        *,
        space_id: str | None = None,
        validate_spaces: bool | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/detection_engine/rules/prepackaged/_status", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def install_prepackaged_rules(
        self,
        *,
        space_id: str | None = None,
        validate_spaces: bool | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/detection_engine/rules/prepackaged", space_id
        )
        return await self.perform_request(
            "PUT",
            path,
    ...
    async def preview_rule(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/rules/preview", space_id)
        return await self.perform_request(
            "POST",
            path,
            params=params if params else None,
    ...
    async def get_tags(
        ...
        *,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/tags", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    async def search_alerts(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/signals/search", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def set_alert_status(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/signals/status", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def set_alert_tags(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/detection_engine/signals/tags", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def set_alert_assignees(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/detection_engine/signals/assignees", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def create_alerts_migration(
        self,
        *,
        index: list[str],
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/detection_engine/signals/migration", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def get_alerts_migration_status(
        self,
        *,
        from_: str,
        space_id: str | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/detection_engine/signals/migration_status", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def finalize_alerts_migration(
        self,
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/detection_engine/signals/finalize_migration", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def delete_alerts_migration(
        self,
        *,
        migration_ids: list[str],
        space_id: str | None = None,
