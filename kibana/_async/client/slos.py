"""Async Kibana SLOs (Service Level Objectives) API client."""
...
class AsyncSlosClient(AsyncNamespaceClient):
    """Async client for the Kibana SLOs (Service Level Objectives) API.
    ...
    Example:
        ...
        >>> await client.slos.get(slo_id=slo_id)  # doctest: +SKIP
        >>> await client.slos.delete(slo_id=slo_id)  # doctest: +SKIP
    """
    ...
    async def get(
        ...
        *,
        ...
        Example:
            >>> slo = await client.slos.get(slo_id="my-slo-id")
            >>> print(slo.body["name"], slo.body["enabled"])
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"{_SLOS_PATH}/{_quote(slo_id)}", space_id)
        params: dict[str, Any] = {}
    ...
    async def enable(
        ...
        *,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"{_SLOS_PATH}/{_quote(slo_id)}/enable", space_id)
        return await self.perform_request(
            method="POST",
            path=path,
        )
    ...
    async def disable(
        ...
        *,
        ...
        path = self._build_space_path(
            f"{_SLOS_PATH}/{_quote(slo_id)}/disable", space_id
        )
        return await self.perform_request(
            method="POST",
            path=path,
    ...
    async def reset(
        ...
        *,
        ...
        Example:
            >>> resp = await client.slos.reset(slo_id="my-slo-id")
            >>> print(resp.body["version"])
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"{_SLOS_PATH}/{_quote(slo_id)}/_reset", space_id)
        return await self.perform_request(
            method="POST",
            path=path,
        )
    ...
    async def delete_instances(
        ...
        *,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"{_SLOS_PATH}/_delete_instances", space_id)
        return await self.perform_request(
            method="POST",
            path=path,
            body={"list": instances},
    ...
    async def bulk_delete(
        ...
        *,
        ...
        Example:
            >>> resp = await client.slos.bulk_delete(slo_ids=["slo-1", "slo-2"])
            >>> status = await client.slos.bulk_delete_status(
            ...     task_id=resp.body["taskId"]
            ... )
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"{_SLOS_PATH}/_bulk_delete", space_id)
        return await self.perform_request(
            method="POST",
            path=path,
            body={"list": slo_ids},
    ...
    async def bulk_delete_status(
        ...
        *,
        ...
        Example:
            >>> status = await client.slos.bulk_delete_status(task_id="...")
    ...
    async def bulk_purge_rollup(
        ...
        *,
        ...
        Example:
            >>> resp = await client.slos.bulk_purge_rollup(
            ...     slo_ids=["my-slo-id"],
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"{_SLOS_PATH}/_bulk_purge_rollup", space_id)
        return await self.perform_request(
            method="POST",
            path=path,
    ...
    async def find_definitions(
        ...
        *,
        ...
        Example:
            >>> resp = await client.slos.find_definitions(search="my-service*")
            >>> print(resp.body["total"])
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(f"{_SLOS_PATH}/_definitions", space_id)
        params: dict[str, Any] = {}
