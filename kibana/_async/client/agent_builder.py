"""Async Kibana Agent Builder API client."""
...
class AsyncAgentBuilderClient(AsyncNamespaceClient):
    """Async client for the Kibana Agent Builder API.
    ...
    async def list_agents(
        ...
        *,
        ...
        Example:
            >>> agents = await client.agent_builder.list_agents()
            >>> for agent in agents.body["results"]:
            ...     print(agent["id"], agent["name"])
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/agents", space_id)
    ...
    async def create_agent(
        ...
        *,
        ...
        Example:
            >>> created = await client.agent_builder.create_agent(
            ...     id="search-helper",
            ...     name="Search Helper",
    ...
    async def get_agent(
        ...
        *,
        ...
        Example:
            >>> agent = await client.agent_builder.get_agent(id="elastic-ai-agent")
            >>> print(agent.body["name"])
            Elastic AI Agent
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/agent_builder/agents/{_quote(id)}", space_id
        )
        return await self.perform_request(
            "GET",
            path,
        ...
        *,
        ...
        Args:
            ...
            configuration: Updated configuration settings for the agent
                (see :meth:`AsyncAgentBuilderClient.create_agent`).
        ...
        Example:
            >>> updated = await client.agent_builder.update_agent(
    ...
    async def delete_agent(
        ...
        *,
        ...
        Example:
            >>> result = await client.agent_builder.delete_agent(id="search-helper")
    ...
    async def get_agent_consumption(
        ...
        *,
        ...
        Example:
            >>> consumption = await client.agent_builder.get_agent_consumption(
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/agent_builder/agents/{_quote(agent_id)}/consumption", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def list_tools(
        ...
        *,
        ...
        Example:
            >>> tools = await client.agent_builder.list_tools()
            >>> for tool in tools.body["results"]:
            ...     print(tool["id"], tool["type"])
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/tools", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    async def create_tool(
        ...
        *,
        ...
        Example:
            >>> created = await client.agent_builder.create_tool(
    ...
    async def get_tool(
        ...
        *,
        ...
        Example:
            >>> tool = await client.agent_builder.get_tool(tool_id="my_ns.error_count")
            >>> print(tool.body["type"])
            esql
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/agent_builder/tools/{_quote(tool_id)}", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def update_tool(
        ...
        *,
        ...
        Example:
            >>> updated = await client.agent_builder.update_tool(
    ...
    async def delete_tool(
        ...
        *,
        ...
        Example:
            >>> result = await client.agent_builder.delete_tool(
    ...
    async def execute_tool(
        ...
        *,
        ...
        Example:
            >>> executed = await client.agent_builder.execute_tool(
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/tools/_execute", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def list_conversations(
        ...
        *,
        ...
        Example:
            >>> conversations = await client.agent_builder.list_conversations(
            ...     agent_id="elastic-ai-agent"
            ... )
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/conversations", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params,
    ...
    async def get_conversation(
        ...
        *,
        ...
        Example:
            >>> conversation = await client.agent_builder.get_conversation(
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/agent_builder/conversations/{_quote(conversation_id)}", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def delete_conversation(
        ...
        *,
        ...
        Example:
            >>> await client.agent_builder.delete_conversation(
            ...     conversation_id="696ccd6d-4bff-4b26-a62e-522ccf2dcd16"
            ... )
        """
        await self._maybe_validate_space(space_id, validate_spaces)
    ...
    async def list_attachments(
        ...
        *,
        ...
        Example:
            >>> attachments = await client.agent_builder.list_attachments(
            ...     conversation_id="696ccd6d-4bff-4b26-a62e-522ccf2dcd16",
    ...
    async def create_attachment(
        ...
        *,
        ...
        Example:
            >>> attachment = await client.agent_builder.create_attachment(
            ...     conversation_id="696ccd6d-4bff-4b26-a62e-522ccf2dcd16",
            ...     type="text",
    ...
    async def update_attachment(
        ...
        *,
        ...
        Example:
            >>> updated = await client.agent_builder.update_attachment(
            ...     conversation_id="696ccd6d-4bff-4b26-a62e-522ccf2dcd16",
            ...     attachment_id="att-1",
    ...
    async def rename_attachment(
        ...
        *,
        ...
        Example:
            >>> renamed = await client.agent_builder.rename_attachment(
            ...     conversation_id="696ccd6d-4bff-4b26-a62e-522ccf2dcd16",
            ...     attachment_id="att-1",
    ...
    async def delete_attachment(
        ...
        *,
        ...
        :meth:`AsyncAgentBuilderClient.restore_attachment`.
    ...
    async def restore_attachment(
        ...
        *,
        ...
        Example:
            >>> restored = await client.agent_builder.restore_attachment(
            ...     conversation_id="696ccd6d-4bff-4b26-a62e-522ccf2dcd16",
            ...     attachment_id="att-1",
            ... )
        """
    ...
    async def update_attachment_origin(
        self,
        *,
        conversation_id: str,
        attachment_id: str,
        ...
        Example:
            >>> updated = await client.agent_builder.update_attachment_origin(
            ...     conversation_id="696ccd6d-4bff-4b26-a62e-522ccf2dcd16",
            ...     attachment_id="att-1",
            ...     origin="abc123",
            ... )
    ...
    async def check_stale_attachments(
        self,
        *,
        conversation_id: str,
        space_id: str | None = None,
        ...
        Example:
            >>> staleness = await client.agent_builder.check_stale_attachments(
            ...     conversation_id="696ccd6d-4bff-4b26-a62e-522ccf2dcd16"
            ... )
    ...
    async def converse(
        ...
        *,
        ...
        :meth:`AsyncAgentBuilderClient.converse_async` for a streaming
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/converse", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def converse_async(
        ...
        *,
        ...
        Example:
            >>> stream = await client.agent_builder.converse_async(
            ...     input="What is Elasticsearch?"
            ... )
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/converse/async", space_id)
        return await self.perform_request(
            "POST",
            path,
    ...
    async def get_a2a_card(
        ...
        *,
        ...
        Example:
            >>> card = await client.agent_builder.get_a2a_card(
            ...     agent_id="elastic-ai-agent"
            ... )
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/agent_builder/a2a/{_quote(agent_id)}.json", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def send_a2a_task(
        ...
        *,
        ...
        Example:
            >>> response = await client.agent_builder.send_a2a_task(
            ...     agent_id="elastic-ai-agent",
            ...     payload={
            ...         "jsonrpc": "2.0",
            ...         "id": "task-1",
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/agent_builder/a2a/{_quote(agent_id)}", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def send_mcp_request(
        ...
        *,
        ...
        Example:
            >>> response = await client.agent_builder.send_mcp_request(
            ...     payload={
            ...         "jsonrpc": "2.0",
            ...         "id": 1,
            ...         "method": "initialize",
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/mcp", space_id)
        return await self.perform_request(
            "POST",
            path,
            params=params,
    ...
    async def list_skills(
        ...
        *,
        ...
        Example:
            >>> skills = await client.agent_builder.list_skills()
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/skills", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params,
    ...
    async def create_skill(
        ...
        *,
        ...
        Example:
            >>> created = await client.agent_builder.create_skill(
            ...     id="triage-errors",
            ...     name="Triage errors",
    ...
    async def get_skill(
        ...
        *,
        ...
        Example:
            >>> skill = await client.agent_builder.get_skill(skill_id="triage-errors")
            >>> print(skill.body["name"])
            Triage errors
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/agent_builder/skills/{_quote(skill_id)}", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def update_skill(
        ...
        *,
        ...
        Example:
            >>> updated = await client.agent_builder.update_skill(
    ...
    async def delete_skill(
        ...
        *,
        ...
        Example:
            >>> result = await client.agent_builder.delete_skill(
    ...
    async def list_plugins(
        ...
        *,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/plugins", space_id)
        return await self.perform_request(
            "GET",
            path,
            headers={"accept": "application/json"},
    ...
    async def get_plugin(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/agent_builder/plugins/{_quote(plugin_id)}", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def install_plugin(
        ...
        *,
        ...
        Example:
            >>> installed = await client.agent_builder.install_plugin(
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/agent_builder/plugins/install", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
