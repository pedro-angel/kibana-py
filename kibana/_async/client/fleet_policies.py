"""Async Kibana Fleet agent and package policies API client."""
...
class AsyncFleetPoliciesClient(AsyncNamespaceClient):
    ...
    async def get_agent_policies(
        ...
        *,
        ...
        path = self._build_space_path("/api/fleet/agent_policies", space_id)
    ...
    async def bulk_get_agent_policies(
        self,
        *,
        ids: list[str],
        full: bool | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/agent_policies/_bulk_get", space_id)
        return await self.perform_request(
            "POST",
            path,
            params=params or None,
    ...
    async def get_agent_policy(
        ...
        *,
        ...
        path = self._build_space_path(
            f"/api/fleet/agent_policies/{_quote(agent_policy_id)}", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def get_auto_upgrade_agents_status(
        self,
        *,
        agent_policy_id: str,
        space_id: str | None = None,
    ...
    async def copy_agent_policy(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/fleet/agent_policies/{_quote(agent_policy_id)}/copy", space_id
        )
        return await self.perform_request(
            "POST",
            path,
    ...
    async def download_agent_policy(
        self,
        *,
        agent_policy_id: str,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/fleet/agent_policies/{_quote(agent_policy_id)}/download", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def get_full_agent_policy(
        self,
        *,
        agent_policy_id: str,
        download: bool | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/fleet/agent_policies/{_quote(agent_policy_id)}/full", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def get_agent_policy_outputs(
        self,
        *,
        agent_policy_id: str,
        space_id: str | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/fleet/agent_policies/{_quote(agent_policy_id)}/outputs", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def delete_agent_policy(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/agent_policies/delete", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def get_agent_policies_outputs(
        self,
        *,
        ids: list[str],
        space_id: str | None = None,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/agent_policies/outputs", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def create_agentless_policy(
        self,
        *,
        name: str,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/agentless_policies", space_id)
        return await self.perform_request(
            "POST",
            path,
            params=params or None,
    ...
    async def delete_agentless_policy(
        self,
        *,
        policy_id: str,
        force: bool | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/fleet/agentless_policies/{_quote(policy_id)}", space_id
        )
        return await self.perform_request(
            "DELETE",
            path,
    ...
    async def get_package_policies(
        self,
        *,
        page: int | None = None,
        per_page: int | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/package_policies", space_id)
        return await self.perform_request(
            "GET",
            path,
            params=params or None,
    ...
    async def create_package_policy(
        self,
        *,
        name: str,
        package: dict[str, Any],
    ...
    async def bulk_get_package_policies(
        self,
        *,
        ids: list[str],
        ignore_missing: bool | None = None,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/package_policies/_bulk_get", space_id)
        return await self.perform_request(
            "POST",
            path,
            params=params or None,
    ...
    async def get_package_policy(
        ...
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            f"/api/fleet/package_policies/{_quote(package_policy_id)}", space_id
        )
        return await self.perform_request(
            "GET",
            path,
    ...
    async def update_package_policy(
        self,
        *,
        package_policy_id: str,
        package: dict[str, Any],
    ...
    async def delete_package_policy(
        self,
        *,
        package_policy_id: str,
        force: bool | None = None,
    ...
    async def bulk_delete_package_policies(
        self,
        *,
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/package_policies/delete", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def upgrade_package_policies(
        self,
        *,
        package_policy_ids: list[str],
        space_id: str | None = None,
        ...
        """
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path("/api/fleet/package_policies/upgrade", space_id)
        return await self.perform_request(
            "POST",
            path,
            headers={"accept": "application/json"},
    ...
    async def upgrade_package_policies_dry_run(
        self,
        *,
        package_policy_ids: list[str],
        ...
        await self._maybe_validate_space(space_id, validate_spaces)
        path = self._build_space_path(
            "/api/fleet/package_policies/upgrade/dryrun", space_id
        )
        return await self.perform_request(
            "POST",
            path,
